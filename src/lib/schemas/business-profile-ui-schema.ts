    ...
    subSections: [
        {
            ...
            fields: [
                ...
                },
                {
                    ...
                    type: 'multi-select',
                    options: [
                        { value: 'fine_dining', label: 'Fine Dining', icon: '🍷', description: 'Upscale, formal experience' },
                        { value: 'casual_dining', label: 'Casual Dining', icon: '🍽️', description: 'Relaxed, mid-range' },
                        { value: 'qsr', label: 'Quick Service (QSR)', icon: '🍔', description: 'Fast food, counter service' },
                        { value: 'cafe', label: 'Café', icon: '☕', description: 'Coffee, snacks, light meals' },
                        { value: 'bar_lounge', label: 'Bar / Lounge', icon: '🍸', description: 'Focus on drinks' },
                        { value: 'cloud_kitchen', label: 'Cloud Kitchen', icon: '📦', description: 'Delivery only' },
                        { value: 'food_truck', label: 'Food Truck', icon: '🚚', description: 'Mobile vendor' },
                        { value: 'takeaway', label: 'Takeaway', icon: '🥡', description: 'Primarily packed food' },
                        { value: 'bakery', label: 'Bakery', icon: '🥐', description: 'Breads, pastries, cakes' },
                        { value: 'dessert_parlor', label: 'Dessert Parlor', icon: '🍨', description: 'Ice cream, sweets' },
                        { value: 'juice_bar', label: 'Juice Bar', icon: '🧃', description: 'Fresh juices, smoothies' },
                        { value: 'food_court', label: 'Food Court Stall', icon: '🏬', description: 'Mall/complex location' },
                    ],
            ...
            fields: [
                ...
                },
                {
                    ...
                    options: [
                        ...
                        { value: 'private_dining', label: 'Private Dining', icon: '🚪' },
                        { value: 'bar_seating', label: 'Bar Seating', icon: '🪑' },
                        { value: 'booth', label: 'Booth/Cabin', icon: '🛋️' },
            ...
            fields: [
                ...
                },
                {
                    ...
                    options: [
                        ...
                        { value: 'sugar_free', label: 'Sugar-Free', icon: '🚫' },
            ...
            fields: [
                ...
                },
                {
                    ...
                    options: [
                        ...
                        { value: 'grubhub', label: 'Grubhub', icon: '🦗' },
                        ...
                        { value: 'foodpanda', label: 'Foodpanda', icon: '🐼' },
                        { value: 'grab_food', label: 'GrabFood', icon: '🟢' },
                        { value: 'own_delivery', label: 'Own Delivery Fleet', icon: '🛵' },
                    ],
