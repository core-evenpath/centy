            ...
            fields: [
                {
                    key: 'paymentModes', label: 'Payment Modes', type: 'checkbox-group', options: [
                        ...
                        { value: 'digital_wallet', label: 'Digital Wallet/Mobile Pay' },
                        { value: 'bnpl', label: 'Buy Now Pay Later' },
                        { value: 'financing', label: 'Financing/EMI Available' },
    ...
    subSections: [
        ...
        },
        {
            ...
            fields: [
                ...
                { key: 'insuranceProviders', label: 'Insurance Providers', type: 'tags', placeholder: 'Add accepted insurance providers...', schemaPath: 'industrySpecificData.insuranceProviders', showCondition: { field: 'insuranceAccepted', operator: 'equals', value: true }, gridSpan: 2 },
...
export const EDUCATION_EXPERTISE: IndustryExpertiseConfig = {
    ...
    subSections: [
            ...
            fields: [
                {
                    key: 'institutionType', label: 'Institution Type', type: 'select', options: [
                        ...
                        { value: 'coaching', label: 'Test Prep/Coaching' },
                        { value: 'tutoring', label: 'Private Tutoring' },
                        { value: 'skill_training', label: 'Vocational Training' },
                        { value: 'online_platform', label: 'Online Learning Platform' },
                        { value: 'language_school', label: 'Language School' },
                        { value: 'art_music', label: 'Art/Music School' },
                    ], schemaPath: 'industrySpecificData.institutionType'
                },
                { key: 'subjects', label: 'Subjects/Courses Offered', type: 'tags', placeholder: 'e.g., Mathematics, Science, Languages', schemaPath: 'industrySpecificData.subjects', gridSpan: 2 },
                { key: 'boards', label: 'Curriculum/Affiliations', type: 'tags', placeholder: 'Your curriculum or board affiliations', schemaPath: 'industrySpecificData.boards', gridSpan: 2 },
                { key: 'ageGroups', label: 'Age Groups Served', type: 'tags', placeholder: 'e.g., 5-10 years, High school, Adults', schemaPath: 'industrySpecificData.ageGroups' },
            ],
        },
        {
            id: 'learning-mode',
        ...
        },
        {
            ...
            icon: '📝',
            fields: [
                { key: 'feeRange', label: 'Fee Range', type: 'text', placeholder: 'Enter your fee range', schemaPath: 'industrySpecificData.feeRange' },
...
export const REAL_ESTATE_EXPERTISE: IndustryExpertiseConfig = {
    ...
    subSections: [
        ...
        },
        {
            ...
            icon: '📍',
            fields: [
                { key: 'operatingAreas', label: 'Operating Areas', type: 'tags', placeholder: 'Add your service areas/neighborhoods...', schemaPath: 'industrySpecificData.operatingAreas', gridSpan: 2 },
                {
                    key: 'priceSegment', label: 'Price Segment', type: 'checkbox-group', options: [
                        { value: 'budget', label: 'Budget/Starter' },
                ...
                { key: 'licenseRegistered', label: 'Licensed/Registered Agent', type: 'toggle', schemaPath: 'industrySpecificData.licenseRegistered' },
                { key: 'licenseNumber', label: 'License/Registration Number', type: 'text', placeholder: 'Your real estate license number', schemaPath: 'industrySpecificData.licenseNumber', showCondition: { field: 'licenseRegistered', operator: 'equals', value: true } },
            ],
        },
        {
            id: 'services',
            ...
            fields: [
                {
                    key: 'services', label: 'Services', type: 'checkbox-group', options: [
                        { value: 'site_visits', label: 'Property Tours/Showings' },
                        { value: 'legal_assistance', label: 'Legal Assistance' },
                        { value: 'loan_assistance', label: 'Mortgage/Loan Assistance' },
    ...
    subSections: [
        {
            ...
            fields: [
                ...
                { key: 'servicesOffered', label: 'Services Offered', type: 'tags', placeholder: 'e.g., Tax Filing, Company Registration, Accounting', schemaPath: 'industrySpecificData.servicesOffered', gridSpan: 2 },
        ...
        },
        {
            ...
            fields: [
                ...
                { key: 'minEngagement', label: 'Minimum Engagement', type: 'text', placeholder: 'e.g., $500 or 10 hours', schemaPath: 'industrySpecificData.minEngagement' },
            ],
        },
        {
            id: 'expertise',
    ...
    subSections: [
        ...
        },
        {
            ...
            fields: [
                ...
                { key: 'priceRange', label: 'Price Range', type: 'text', placeholder: 'Enter your typical price range', schemaPath: 'industrySpecificData.priceRange' },
    ...
    subSections: [
            ...
            fields: [
                {
                    key: 'businessType', label: 'Business Type', type: 'select', options: [
                        ...
                        { value: 'investment_advisor', label: 'Registered Investment Advisor (RIA)' },
                        { value: 'insurance_agent', label: 'Insurance Agent/Broker' },
                        { value: 'loan_agent', label: 'Loan Agent/Broker' },
                        { value: 'wealth_manager', label: 'Wealth Manager' },
                        { value: 'accounting_firm', label: 'Accounting/CPA Firm' },
                        ...
                        { value: 'lending_institution', label: 'Non-Bank Lending Institution' },
                ...
                },
                {
                    key: 'primaryServices', label: 'Primary Services', type: 'multi-select', options: [
                        { value: 'mutual_funds', label: 'Mutual Fund Distribution', description: 'Fund investments and advisory' },
                        { value: 'equity', label: 'Equity/Stock Advisory', description: 'Direct equity recommendations' },
                        { value: 'insurance_life', label: 'Life Insurance', description: 'Term, Whole life, Annuities' },
                        { value: 'insurance_health', label: 'Health Insurance', description: 'Individual, Family plans' },
                        { value: 'insurance_general', label: 'General Insurance', description: 'Motor, Home, Travel' },
                        { value: 'tax_planning', label: 'Tax Planning & Filing', description: 'Tax return, strategies' },
                        { value: 'retirement_planning', label: 'Retirement Planning', description: 'Pension, retirement accounts' },
                        { value: 'loan_home', label: 'Home Loans', description: 'Mortgage, Housing finance' },
                        { value: 'loan_personal', label: 'Personal Loans', description: 'Unsecured lending' },
                        { value: 'loan_business', label: 'Business Loans', description: 'SME, Working capital' },
                        { value: 'loan_lap', label: 'Loan Against Property', description: 'Secured loans' },
                        { value: 'fixed_deposits', label: 'Fixed Deposits', description: 'Bank & Corporate deposits' },
                        { value: 'bonds', label: 'Bonds & Debentures', description: 'Government & Corporate bonds' },
                        { value: 'pms', label: 'Portfolio Management', description: 'Discretionary services' },
                        { value: 'aif', label: 'Alternative Investments', description: 'Hedge funds, Private equity' },
                ...
                { key: 'specializations', label: 'Specializations', type: 'tags', placeholder: 'e.g., Expat Taxation, Startup Funding, High Net Worth', schemaPath: 'industrySpecificData.specializations', aiSuggestionEnabled: true, gridSpan: 2 },
            ],
        },
        {
            ...
            fields: [
                {
                    key: 'investmentProducts', label: 'Investment Products', type: 'checkbox-group', options: [
                        ...
                        { value: 'bond_funds', label: 'Bond/Debt Funds' },
                        { value: 'balanced_funds', label: 'Balanced/Hybrid Funds' },
                        { value: 'index_funds', label: 'Index Funds & ETFs' },
                        { value: 'tax_advantaged', label: 'Tax-Advantaged Funds' },
                        ...
                        { value: 'reits', label: 'REITs/Real Estate Funds' },
                ...
                },
                {
                    key: 'insuranceProducts', label: 'Insurance Products', type: 'checkbox-group', options: [
                        ...
                        { value: 'universal_life', label: 'Universal/Variable Life' },
                        { value: 'annuities', label: 'Annuities' },
                        { value: 'health_individual', label: 'Health - Individual' },
                        { value: 'health_family', label: 'Health - Family' },
                        { value: 'health_senior', label: 'Health - Senior/Medicare' },
                        { value: 'critical_illness', label: 'Critical Illness' },
                        { value: 'motor', label: 'Auto/Motor Insurance' },
                ...
                },
                {
                    key: 'loanProducts', label: 'Loan Products', type: 'checkbox-group', options: [
                        ...
                        { value: 'refinance', label: 'Refinance/Balance Transfer' },
                        { value: 'lap', label: 'Loan Against Property' },
                        { value: 'personal_loan', label: 'Personal Loan' },
                        { value: 'business_loan', label: 'Business Loan' },
                        { value: 'sme_loan', label: 'SME/Small Business Loan' },
                        { value: 'car_loan', label: 'Auto/Car Loan' },
                        { value: 'education_loan', label: 'Education/Student Loan' },
                        { value: 'secured_loan', label: 'Secured/Collateral Loan' },
                        { value: 'credit_card', label: 'Credit Cards' },
                        { value: 'line_of_credit', label: 'Line of Credit' },
                        { value: 'working_capital', label: 'Working Capital' },
                    ], schemaPath: 'industrySpecificData.loanProducts', gridSpan: 2
                },
                { key: 'partnerBanks', label: 'Partner Banks/Fund Houses/Insurers', type: 'tags', placeholder: 'Add your partner institutions...', schemaPath: 'industrySpecificData.partnerInstitutions', gridSpan: 2, fetchable: true },
            ],
        },
        {
            id: 'licensing',
            ...
            fields: [
                {
                    key: 'regulatoryRegistrations', label: 'Regulatory Registrations', type: 'checkbox-group', options: [
                        { value: 'investment_advisor', label: 'Registered Investment Advisor' },
                        { value: 'broker_dealer', label: 'Broker-Dealer License' },
                        { value: 'insurance_license', label: 'Insurance License' },
                        { value: 'mortgage_license', label: 'Mortgage/Lending License' },
                        { value: 'accounting_license', label: 'Accounting/CPA License' },
                        { value: 'financial_planner', label: 'Financial Planner Certification' },
                        { value: 'securities_license', label: 'Securities License' },
                        { value: 'fund_distributor', label: 'Fund Distributor License' },
                    ], schemaPath: 'industrySpecificData.regulatoryRegistrations', gridSpan: 2, validation: { required: true }
                },
                { key: 'licenseNumber', label: 'Primary License/Registration No.', type: 'text', placeholder: 'Enter your main registration number', schemaPath: 'industrySpecificData.licenseNumber' },
                { key: 'secondaryLicenseNumber', label: 'Secondary License No.', type: 'text', placeholder: 'Additional registration if applicable', schemaPath: 'industrySpecificData.secondaryLicenseNumber' },
                { key: 'taxId', label: 'Tax ID/Business Registration', type: 'text', placeholder: 'Business tax registration number', schemaPath: 'industrySpecificData.taxId' },
                { key: 'professionalCertifications', label: 'Professional Certifications', type: 'tags', placeholder: 'e.g., CFP, CFA, CPA', schemaPath: 'industrySpecificData.professionalCertifications', gridSpan: 2 },
                { key: 'insuranceCover', label: 'Professional Indemnity Insurance', type: 'toggle', schemaPath: 'industrySpecificData.insuranceCover' },
                { key: 'insuranceCoverAmount', label: 'Indemnity Cover Amount', type: 'currency', placeholder: 'Coverage amount', schemaPath: 'industrySpecificData.insuranceCoverAmount', showCondition: { field: 'insuranceCover', operator: 'equals', value: true } },
            ],
        },
        {
            id: 'client-segments',
            ...
            fields: [
                {
                    key: 'clientTypes', label: 'Client Types Served', type: 'checkbox-group', options: [
                        ...
                        { value: 'uhni', label: 'Ultra High Net Worth (UHNI)' },
                        { value: 'expat', label: 'Expats/Non-Residents' },
                        { value: 'senior_citizens', label: 'Senior Citizens/Retirees' },
                ...
                { key: 'typicalPortfolio', label: 'Typical Client Portfolio Size', type: 'text', placeholder: 'Enter typical portfolio range', schemaPath: 'industrySpecificData.typicalPortfolio' },
                {
        ...
        },
        {
            ...
            fields: [
                ...
                { key: 'financialPlanFee', label: 'Financial Plan Fee', type: 'text', placeholder: 'Enter your planning fee range', schemaPath: 'industrySpecificData.financialPlanFee' },
        ...
        },
        {
            ...
            fields: [
                ...
                { key: 'aumManaged', label: 'AUM Managed (approx)', type: 'text', placeholder: 'Enter approximate AUM', schemaPath: 'industrySpecificData.aumManaged' },
                { key: 'teamSize', label: 'Team Size', type: 'select', options: [
