...
export const DEFAULT_PROCESSES: ModelProcessConfig[] = [
  ...
  },
  {
    ...
    description: 'Generates comprehensive module configs, inventory items, and fields',
    category: 'generation',
    currentModel: 'claude-sonnet-4-20250514',
    provider: 'Anthropic',
  ...
  },
  {
    ...
    description: 'AI-powered module operations: bulk generation, field suggestions, and more',
    category: 'generation',
    currentModel: 'claude-sonnet-4-20250514',
    provider: 'Anthropic',
