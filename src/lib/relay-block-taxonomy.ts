...
const TAXONOMY_BLOCK_MAPPINGS: TaxonomyBlockMapping[] = [
    ...
    { functionId: 'ecommerce_d2c', primaryBlocks: ['catalog', 'products', 'compare', 'contact', 'greeting', 'promo', 'product_detail', 'cart', 'checkout', 'confirmation', 'skin_quiz', 'concern_picker', 'routine_builder', 'shade_finder', 'bundle', 'subscription'], secondaryBlocks: ['ingredients', 'reviews', 'gift_card', 'order_tracker', 'return_exchange', 'reorder', 'loyalty', 'wishlist', 'referral', 'social_proof', 'feedback', 'booking', 'quick_actions'], excludedBlocks: ['menu', 'rooms', 'book', 'schedule', 'location'] },
