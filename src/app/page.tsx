          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="relative z-10">
                ...
                <div className="relative">
                  <Image 
                    src="https://firebasestorage.googleapis.com/v0/b/flutter-runs.appspot.com/o/14a1a511-b959-4d6d-a16f-4743ef0e2518.png?alt=media&token=e1f7c3b2-6031-468b-91c8-23e593e8784d"
