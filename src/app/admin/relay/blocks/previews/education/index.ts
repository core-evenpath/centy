...
const EDU_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'enrollment', family: 'conversion', label: 'Enrollment Form', stage: 'conversion', desc: 'Registration flow with course summary, payment plan selector', preview: MiniEnrollment, intents: ['enroll', 'register', 'sign up', 'apply'], module: 'education_conversion', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'cta_label'] },
  { id: 'progress', family: 'tracking', label: 'Progress Dashboard', stage: 'social_proof', desc: 'Circular completion chart, module progress bars, next deadline', preview: MiniProgress, intents: ['progress', 'how am I doing', 'grades'], module: 'education_tracking', status: 'active', reads: ['name', 'description', 'image_url', 'status', 'last_updated'] },
  { id: 'assessment', family: 'tracking', label: 'Assessment Result', stage: 'social_proof', desc: 'Test score with section breakdown, percentile ranking', preview: MiniAssessment, intents: ['results', 'score', 'quiz', 'test'], module: 'education_tracking', status: 'active', reads: ['name', 'description', 'image_url', 'status', 'last_updated'] },
  { id: 'fee_structure', family: 'pricing', label: 'Fee Structure', stage: 'showcase', desc: 'Itemized fee table with total, scholarship indicator', preview: MiniFeeStructure, intents: ['fees', 'cost', 'pricing', 'tuition'], module: 'education_pricing', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'currency'] },
  { id: 'student_review', family: 'social_proof', label: 'Student Reviews', stage: 'social_proof', desc: 'Aggregate score with criteria bars, individual reviews', preview: MiniStudentReview, intents: ['reviews', 'ratings', 'testimonials'], module: 'education_social_proof', status: 'active', reads: ['name', 'description', 'image_url', 'rating', 'review_count'] },
  ...
  { id: 'facility', family: 'info', label: 'Campus / Facility', stage: 'discovery', desc: 'Campus photo grid, facility list, virtual tour link', preview: MiniFacility, intents: ['campus', 'facility', 'location', 'labs'], module: 'education_info', status: 'active', engines: ['info'], reads: ['name', 'description', 'image_url'] },
];
