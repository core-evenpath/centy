...
const EDU_BLOCKS: VerticalBlockDef[] = [
  { id: 'course_card', family: 'catalog', label: 'Course Card', stage: 'discovery', desc: 'Browsable course with instructor, level badge, duration, student count, rating, price', preview: MiniCourseCard, intents: ['courses', 'browse', 'programs', 'classes'], module: 'education_catalog', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'category', 'currency', 'subtitle', 'rating', 'review_count', 'badges', 'variants', 'sku'] },
  { id: 'course_detail', family: 'catalog', label: 'Course Detail', stage: 'showcase', desc: 'Full course view with instructor bio, stats, learning outcomes, pricing', preview: MiniCourseDetail, intents: ['details', 'tell me more', 'syllabus'], module: 'education_catalog', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'category', 'currency', 'subtitle', 'rating', 'review_count', 'badges', 'variants', 'sku'] },
  { id: 'schedule', family: 'timetable', label: 'Schedule / Timetable', stage: 'showcase', desc: 'Weekly class grid with day columns, color-coded subject slots', preview: MiniSchedule, intents: ['schedule', 'timetable', 'when', 'class times'], module: 'education_timetable', status: 'active', reads: ['name', 'description', 'image_url'] },
  { id: 'instructor', family: 'people', label: 'Instructor Profile', stage: 'discovery', desc: 'Teacher card with credentials, subject tags, rating, student count', preview: MiniInstructor, intents: ['instructor', 'teacher', 'professor', 'who teaches'], module: 'education_people', status: 'active', reads: ['name', 'description', 'image_url', 'subtitle', 'badges', 'rating', 'review_count', 'specialties', 'years_experience', 'role', 'availability'] },
  { id: 'curriculum', family: 'content', label: 'Curriculum Outline', stage: 'showcase', desc: 'Module breakdown with numbered steps, completion status', preview: MiniCurriculum, intents: ['curriculum', 'modules', 'topics', 'syllabus'], module: 'education_content', status: 'active', reads: ['name', 'description', 'image_url'] },
  { id: 'enrollment', family: 'conversion', label: 'Enrollment Form', stage: 'conversion', desc: 'Registration flow with course summary, payment plan selector', preview: MiniEnrollment, intents: ['enroll', 'register', 'sign up', 'apply'], module: 'education_conversion', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'cta_label', 'currency', 'badges', 'discount_percent', 'urgency_text'] },
  { id: 'progress', family: 'tracking', label: 'Progress Dashboard', stage: 'social_proof', desc: 'Circular completion chart, module progress bars, next deadline', preview: MiniProgress, intents: ['progress', 'how am I doing', 'grades'], module: 'education_tracking', status: 'active', reads: ['name', 'description', 'image_url', 'status', 'last_updated', 'eta', 'location', 'progress', 'destination'] },
  { id: 'assessment', family: 'tracking', label: 'Assessment Result', stage: 'social_proof', desc: 'Test score with section breakdown, percentile ranking', preview: MiniAssessment, intents: ['results', 'score', 'quiz', 'test'], module: 'education_tracking', status: 'active', reads: ['name', 'description', 'image_url', 'status', 'last_updated', 'eta', 'location', 'progress', 'destination'] },
  { id: 'fee_structure', family: 'pricing', label: 'Fee Structure', stage: 'showcase', desc: 'Itemized fee table with total, scholarship indicator', preview: MiniFeeStructure, intents: ['fees', 'cost', 'pricing', 'tuition'], module: 'education_pricing', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'currency', 'subtitle', 'features', 'period'] },
  { id: 'student_review', family: 'social_proof', label: 'Student Reviews', stage: 'social_proof', desc: 'Aggregate score with criteria bars, individual reviews', preview: MiniStudentReview, intents: ['reviews', 'ratings', 'testimonials'], module: 'education_social_proof', status: 'active', reads: ['name', 'description', 'image_url', 'rating', 'review_count', 'subtitle', 'badges', 'author', 'verified', 'date'] },
  { id: 'batch_selector', family: 'scheduling', label: 'Batch / Cohort Selector', stage: 'conversion', desc: 'Batch picker with dates, times, mode, seat availability', preview: MiniBatchSelector, intents: ['batch', 'start date', 'cohort', 'next batch'], module: 'education_scheduling', status: 'active', reads: ['name', 'description', 'image_url'] },
  { id: 'certificate', family: 'credentials', label: 'Certificate / Credential', stage: 'social_proof', desc: 'Formal completion certificate with verification ID', preview: MiniCertificate, intents: ['certificate', 'credential', 'diploma'], module: 'education_credentials', status: 'active', reads: ['name', 'description', 'image_url'] },
  { id: 'resources', family: 'content', label: 'Learning Resources', stage: 'discovery', desc: 'Material library with type-coded icons', preview: MiniResources, intents: ['resources', 'materials', 'downloads', 'videos'], module: 'education_content', status: 'active', reads: ['name', 'description', 'image_url'] },
  // engines: ['info'] — campus/facility directory is pure info surface (hours, location, virtual-tour navigation)
  { id: 'facility', family: 'info', label: 'Campus / Facility', stage: 'discovery', desc: 'Campus photo grid, facility list, virtual tour link', preview: MiniFacility, intents: ['campus', 'facility', 'location', 'labs'], module: 'education_info', status: 'active', engines: ['info'], reads: ['name', 'description', 'image_url', 'cta_label', 'icon', 'subtitle'] },
];
