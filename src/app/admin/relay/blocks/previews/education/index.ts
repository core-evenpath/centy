...
const EDU_BLOCKS: VerticalBlockDef[] = [
  { id: 'course_card', family: 'catalog', label: 'Course Card', stage: 'discovery', desc: 'Browsable course with instructor, level badge, duration, student count, rating, price', preview: MiniCourseCard, intents: ['courses', 'browse', 'programs', 'classes'], module: 'items', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'category'] },
  { id: 'course_detail', family: 'catalog', label: 'Course Detail', stage: 'showcase', desc: 'Full course view with instructor bio, stats, learning outcomes, pricing', preview: MiniCourseDetail, intents: ['details', 'tell me more', 'syllabus'], module: 'items', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'category'] },
  ...
  { id: 'instructor', family: 'people', label: 'Instructor Profile', stage: 'discovery', desc: 'Teacher card with credentials, subject tags, rating, student count', preview: MiniInstructor, intents: ['instructor', 'teacher', 'professor', 'who teaches'], module: 'items', status: 'active', reads: ['name', 'description', 'image_url', 'subtitle', 'badges'] },
