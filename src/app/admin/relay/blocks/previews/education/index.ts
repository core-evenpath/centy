...
const EDU_BLOCKS: VerticalBlockDef[] = [
  { id: 'course_card', family: 'catalog', label: 'Course Card', stage: 'discovery', desc: 'Browsable course with instructor, level badge, duration, student count, rating, price', preview: MiniCourseCard, intents: ['courses', 'browse', 'programs', 'classes'], module: 'moduleItems', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'category'] },
  { id: 'course_detail', family: 'catalog', label: 'Course Detail', stage: 'showcase', desc: 'Full course view with instructor bio, stats, learning outcomes, pricing', preview: MiniCourseDetail, intents: ['details', 'tell me more', 'syllabus'], module: 'moduleItems', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'category'] },
  { id: 'schedule', family: 'timetable', label: 'Schedule / Timetable', stage: 'showcase', desc: 'Weekly class grid with day columns, color-coded subject slots', preview: MiniSchedule, intents: ['schedule', 'timetable', 'when', 'class times'], module: null, status: 'active', noModuleReason: 'ai_generated' },
  { id: 'instructor', family: 'people', label: 'Instructor Profile', stage: 'discovery', desc: 'Teacher card with credentials, subject tags, rating, student count', preview: MiniInstructor, intents: ['instructor', 'teacher', 'professor', 'who teaches'], module: 'moduleItems', status: 'active', reads: ['name', 'description', 'image_url', 'subtitle', 'badges'] },
  { id: 'curriculum', family: 'content', label: 'Curriculum Outline', stage: 'showcase', desc: 'Module breakdown with numbered steps, completion status', preview: MiniCurriculum, intents: ['curriculum', 'modules', 'topics', 'syllabus'], module: null, status: 'active', noModuleReason: 'ai_generated' },
  { id: 'enrollment', family: 'conversion', label: 'Enrollment Form', stage: 'conversion', desc: 'Registration flow with course summary, payment plan selector', preview: MiniEnrollment, intents: ['enroll', 'register', 'sign up', 'apply'], module: null, status: 'active', noModuleReason: 'ai_generated' },
  { id: 'progress', family: 'tracking', label: 'Progress Dashboard', stage: 'social_proof', desc: 'Circular completion chart, module progress bars, next deadline', preview: MiniProgress, intents: ['progress', 'how am I doing', 'grades'], module: null, status: 'active', noModuleReason: 'ai_generated' },
  { id: 'assessment', family: 'tracking', label: 'Assessment Result', stage: 'social_proof', desc: 'Test score with section breakdown, percentile ranking', preview: MiniAssessment, intents: ['results', 'score', 'quiz', 'test'], module: null, status: 'active', noModuleReason: 'ai_generated' },
  { id: 'fee_structure', family: 'pricing', label: 'Fee Structure', stage: 'showcase', desc: 'Itemized fee table with total, scholarship indicator', preview: MiniFeeStructure, intents: ['fees', 'cost', 'pricing', 'tuition'], module: null, status: 'active', noModuleReason: 'ai_generated' },
  { id: 'student_review', family: 'social_proof', label: 'Student Reviews', stage: 'social_proof', desc: 'Aggregate score with criteria bars, individual reviews', preview: MiniStudentReview, intents: ['reviews', 'ratings', 'testimonials'], module: null, status: 'active', noModuleReason: 'design_only' },
  { id: 'batch_selector', family: 'scheduling', label: 'Batch / Cohort Selector', stage: 'conversion', desc: 'Batch picker with dates, times, mode, seat availability', preview: MiniBatchSelector, intents: ['batch', 'start date', 'cohort', 'next batch'], module: null, status: 'active', noModuleReason: 'ai_generated' },
  { id: 'certificate', family: 'credentials', label: 'Certificate / Credential', stage: 'social_proof', desc: 'Formal completion certificate with verification ID', preview: MiniCertificate, intents: ['certificate', 'credential', 'diploma'], module: null, status: 'active', noModuleReason: 'ai_generated' },
  { id: 'resources', family: 'content', label: 'Learning Resources', stage: 'discovery', desc: 'Material library with type-coded icons', preview: MiniResources, intents: ['resources', 'materials', 'downloads', 'videos'], module: null, status: 'active', noModuleReason: 'ai_generated' },
  // engines: ['info'] — campus/facility directory is pure info surface (hours, location, virtual-tour navigation)
  { id: 'facility', family: 'info', label: 'Campus / Facility', stage: 'discovery', desc: 'Campus photo grid, facility list, virtual tour link', preview: MiniFacility, intents: ['campus', 'facility', 'location', 'labs'], module: null, status: 'active', engines: ['info'], noModuleReason: 'ai_generated' },
];
