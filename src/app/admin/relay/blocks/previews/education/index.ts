...
const EDU_BLOCKS: VerticalBlockDef[] = [
  { id: 'course_card', family: 'catalog', label: 'Course Card', stage: 'discovery', desc: 'Browsable course with instructor, level badge, duration, student count, rating, price', preview: MiniCourseCard, intents: ['courses', 'browse', 'programs', 'classes'], module: 'moduleItems', status: 'active' },
  { id: 'course_detail', family: 'catalog', label: 'Course Detail', stage: 'showcase', desc: 'Full course view with instructor bio, stats, learning outcomes, pricing', preview: MiniCourseDetail, intents: ['details', 'tell me more', 'syllabus'], module: 'moduleItems', status: 'active' },
  { id: 'schedule', family: 'timetable', label: 'Schedule / Timetable', stage: 'showcase', desc: 'Weekly class grid with day columns, color-coded subject slots', preview: MiniSchedule, intents: ['schedule', 'timetable', 'when', 'class times'], module: null, status: 'active' },
  { id: 'instructor', family: 'people', label: 'Instructor Profile', stage: 'discovery', desc: 'Teacher card with credentials, subject tags, rating, student count', preview: MiniInstructor, intents: ['instructor', 'teacher', 'professor', 'who teaches'], module: 'moduleItems', status: 'active' },
  { id: 'curriculum', family: 'content', label: 'Curriculum Outline', stage: 'showcase', desc: 'Module breakdown with numbered steps, completion status', preview: MiniCurriculum, intents: ['curriculum', 'modules', 'topics', 'syllabus'], module: null, status: 'active' },
  { id: 'enrollment', family: 'conversion', label: 'Enrollment Form', stage: 'conversion', desc: 'Registration flow with course summary, payment plan selector', preview: MiniEnrollment, intents: ['enroll', 'register', 'sign up', 'apply'], module: null, status: 'active' },
  { id: 'progress', family: 'tracking', label: 'Progress Dashboard', stage: 'social_proof', desc: 'Circular completion chart, module progress bars, next deadline', preview: MiniProgress, intents: ['progress', 'how am I doing', 'grades'], module: null, status: 'active' },
  { id: 'assessment', family: 'tracking', label: 'Assessment Result', stage: 'social_proof', desc: 'Test score with section breakdown, percentile ranking', preview: MiniAssessment, intents: ['results', 'score', 'quiz', 'test'], module: null, status: 'active' },
  { id: 'fee_structure', family: 'pricing', label: 'Fee Structure', stage: 'showcase', desc: 'Itemized fee table with total, scholarship indicator', preview: MiniFeeStructure, intents: ['fees', 'cost', 'pricing', 'tuition'], module: null, status: 'active' },
  { id: 'student_review', family: 'social_proof', label: 'Student Reviews', stage: 'social_proof', desc: 'Aggregate score with criteria bars, individual reviews', preview: MiniStudentReview, intents: ['reviews', 'ratings', 'testimonials'], module: null, status: 'active' },
