...
const PW_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'gift_card', family: 'marketing', label: 'Gift Card', stage: 'conversion', desc: 'Denomination selector with purchase CTA', preview: MiniGiftCard, intents: ['gift', 'gift card', 'voucher', 'present', 'give'], module: 'personal_wellness_marketing', status: 'active', reads: ['name', 'description', 'image_url', 'cta_label', 'expires_at'] },
  ...
  { id: 'pw_client_review', family: 'proof', label: 'Client Reviews', stage: 'social_proof', desc: 'Service-tagged reviews with criteria bars', preview: MiniClientReview, intents: ['reviews', 'ratings', 'feedback', 'testimonials'], module: 'personal_wellness_proof', status: 'active', reads: ['name', 'description', 'image_url', 'rating', 'review_count'] },
  { id: 'intake_form', family: 'operations', label: 'Client Intake Form', stage: 'conversion', desc: 'Pre-visit health history, allergies, consent checklist', preview: MiniIntakeForm, intents: ['intake', 'form', 'health history', 'allergies', 'consent', 'waiver'], module: 'personal_wellness_operations', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url', 'status', 'last_updated'] },
];
