...
const PW_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'pw_category_browser', family: 'catalog', label: 'Category Browser', stage: 'discovery', desc: 'Visual grid of service categories with item counts', preview: MiniCategoryBrowser, intents: ['categories', 'browse', 'massage', 'facial', 'hair', 'nails'], module: 'personal_wellness_catalog', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'category', 'currency', 'subtitle', 'rating', 'review_count', 'badges', 'variants', 'sku'] },
  { id: 'stylist_profile', family: 'people', label: 'Stylist / Therapist Profile', stage: 'discovery', desc: 'Staff card with specialties, session count, portfolio link', preview: MiniStylistProfile, intents: ['therapist', 'stylist', 'who', 'team', 'specialist'], module: 'personal_wellness_people', status: 'active', reads: ['name', 'description', 'image_url', 'subtitle', 'badges', 'rating', 'review_count', 'specialties', 'years_experience', 'role', 'availability'] },
  { id: 'pw_appointment', family: 'booking', label: 'Appointment Booking', stage: 'conversion', desc: 'Staff preference selector, time slot grid, confirmation CTA', preview: MiniAppointmentBooking, intents: ['book', 'appointment', 'schedule', 'available', 'when'], module: 'personal_wellness_booking', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url', 'date', 'time', 'service_name', 'status', 'duration', 'location', 'price', 'currency', 'attendee_name'] },
  ...
  { id: 'membership_tier', family: 'pricing', label: 'Membership Plans', stage: 'showcase', desc: 'Tier comparison with perks, pricing, best-value badge', preview: MiniMembershipTier, intents: ['membership', 'plans', 'subscribe', 'monthly', 'unlimited'], module: 'personal_wellness_pricing', status: 'active', engines: ['engagement', 'commerce'], reads: ['name', 'description', 'image_url', 'price', 'currency', 'subtitle', 'features', 'period'] },
  { id: 'before_after', family: 'proof', label: 'Before / After Gallery', stage: 'social_proof', desc: 'Side-by-side transformation photos with treatment and client tag', preview: MiniBeforeAfter, intents: ['results', 'before after', 'transformations', 'gallery', 'portfolio'], module: 'personal_wellness_proof', status: 'active', reads: ['name', 'description', 'image_url', 'rating', 'review_count', 'subtitle', 'badges', 'outcome_metric', 'completion_date', 'author'] },
  { id: 'spa_package', family: 'marketing', label: 'Spa / Service Package', stage: 'showcase', desc: 'Bundled services with total duration, savings, combined price', preview: MiniPackageBuilder, intents: ['package', 'combo', 'bundle', 'deal', 'spa day'], module: 'personal_wellness_marketing', status: 'active', reads: ['name', 'description', 'image_url', 'cta_label', 'expires_at', 'headline', 'badges', 'discount_code'] },
  { id: 'class_schedule', family: 'scheduling', label: 'Class Schedule', stage: 'discovery', desc: 'Weekly class timetable with instructor, level, spots remaining', preview: MiniClassSchedule, intents: ['classes', 'schedule', 'yoga', 'fitness', 'meditation', 'timetable'], module: 'personal_wellness_scheduling', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url'] },
  { id: 'gift_card', family: 'marketing', label: 'Gift Card', stage: 'conversion', desc: 'Denomination selector with purchase CTA', preview: MiniGiftCard, intents: ['gift', 'gift card', 'voucher', 'present', 'give'], module: 'personal_wellness_marketing', status: 'active', reads: ['name', 'description', 'image_url', 'cta_label', 'expires_at', 'headline', 'badges', 'discount_code'] },
  ...
  { id: 'loyalty_progress', family: 'retention', label: 'Loyalty / Rewards', stage: 'social_proof', desc: 'Points progress bar, tier status, visit count, rewards earned', preview: MiniLoyaltyProgress, intents: ['rewards', 'points', 'loyalty', 'membership status', 'tier'], module: 'personal_wellness_retention', status: 'active', engines: ['engagement'], reads: ['name', 'description', 'image_url'] },
  { id: 'pw_client_review', family: 'proof', label: 'Client Reviews', stage: 'social_proof', desc: 'Service-tagged reviews with criteria bars', preview: MiniClientReview, intents: ['reviews', 'ratings', 'feedback', 'testimonials'], module: 'personal_wellness_proof', status: 'active', reads: ['name', 'description', 'image_url', 'rating', 'review_count', 'subtitle', 'badges', 'outcome_metric', 'completion_date', 'author'] },
  { id: 'intake_form', family: 'operations', label: 'Client Intake Form', stage: 'conversion', desc: 'Pre-visit health history, allergies, consent checklist', preview: MiniIntakeForm, intents: ['intake', 'form', 'health history', 'allergies', 'consent', 'waiver'], module: 'personal_wellness_operations', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url', 'status', 'last_updated', 'progress', 'assignee', 'priority'] },
];
