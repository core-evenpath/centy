...
const PW_BLOCKS: VerticalBlockDef[] = [
  { id: 'pw_service_card', family: 'catalog', label: 'Service Card', stage: 'discovery', desc: 'Treatment/service with duration, category, pricing, booking count', preview: MiniServiceCard, intents: ['services', 'treatments', 'what do you offer', 'menu'], module: 'moduleItems', status: 'active' },
  { id: 'pw_service_detail', family: 'catalog', label: 'Service Detail', stage: 'showcase', desc: 'Full service view with benefits, duration, pressure level, area', preview: MiniServiceDetail, intents: ['details', 'tell me more', 'what is included'], module: 'moduleItems', status: 'active' },
  { id: 'pw_category_browser', family: 'catalog', label: 'Category Browser', stage: 'discovery', desc: 'Visual grid of service categories with item counts', preview: MiniCategoryBrowser, intents: ['categories', 'browse', 'massage', 'facial', 'hair', 'nails'], module: null, status: 'active' },
  { id: 'stylist_profile', family: 'people', label: 'Stylist / Therapist Profile', stage: 'discovery', desc: 'Staff card with specialties, session count, portfolio link', preview: MiniStylistProfile, intents: ['therapist', 'stylist', 'who', 'team', 'specialist'], module: 'moduleItems', status: 'active' },
  { id: 'pw_appointment', family: 'booking', label: 'Appointment Booking', stage: 'conversion', desc: 'Staff preference selector, time slot grid, confirmation CTA', preview: MiniAppointmentBooking, intents: ['book', 'appointment', 'schedule', 'available', 'when'], module: null, status: 'active', engines: ['booking'] },
  ...
  { id: 'membership_tier', family: 'pricing', label: 'Membership Plans', stage: 'showcase', desc: 'Tier comparison with perks, pricing, best-value badge', preview: MiniMembershipTier, intents: ['membership', 'plans', 'subscribe', 'monthly', 'unlimited'], module: null, status: 'active', engines: ['engagement', 'commerce'] },
  { id: 'before_after', family: 'proof', label: 'Before / After Gallery', stage: 'social_proof', desc: 'Side-by-side transformation photos with treatment and client tag', preview: MiniBeforeAfter, intents: ['results', 'before after', 'transformations', 'gallery', 'portfolio'], module: null, status: 'active' },
  { id: 'spa_package', family: 'marketing', label: 'Spa / Service Package', stage: 'showcase', desc: 'Bundled services with total duration, savings, combined price', preview: MiniPackageBuilder, intents: ['package', 'combo', 'bundle', 'deal', 'spa day'], module: 'moduleItems', status: 'active' },
  { id: 'class_schedule', family: 'scheduling', label: 'Class Schedule', stage: 'discovery', desc: 'Weekly class timetable with instructor, level, spots remaining', preview: MiniClassSchedule, intents: ['classes', 'schedule', 'yoga', 'fitness', 'meditation', 'timetable'], module: null, status: 'active', engines: ['booking'] },
  { id: 'gift_card', family: 'marketing', label: 'Gift Card', stage: 'conversion', desc: 'Denomination selector with purchase CTA', preview: MiniGiftCard, intents: ['gift', 'gift card', 'voucher', 'present', 'give'], module: null, status: 'active' },
  { id: 'pw_product_shop', family: 'retail', label: 'Retail Products', stage: 'discovery', desc: 'Skincare/hair product cards with brand, size, pricing', preview: MiniProductShop, intents: ['products', 'shop', 'buy', 'skincare', 'retail', 'serum'], module: 'moduleItems', status: 'active' },
  // engines: ['engagement'] — loyalty/retention display for engagement partners (memberships, visit streaks)
  { id: 'loyalty_progress', family: 'retention', label: 'Loyalty / Rewards', stage: 'social_proof', desc: 'Points progress bar, tier status, visit count, rewards earned', preview: MiniLoyaltyProgress, intents: ['rewards', 'points', 'loyalty', 'membership status', 'tier'], module: null, status: 'active', engines: ['engagement'] },
  { id: 'pw_client_review', family: 'proof', label: 'Client Reviews', stage: 'social_proof', desc: 'Service-tagged reviews with criteria bars', preview: MiniClientReview, intents: ['reviews', 'ratings', 'feedback', 'testimonials'], module: null, status: 'active' },
  { id: 'intake_form', family: 'operations', label: 'Client Intake Form', stage: 'conversion', desc: 'Pre-visit health history, allergies, consent checklist', preview: MiniIntakeForm, intents: ['intake', 'form', 'health history', 'allergies', 'consent', 'waiver'], module: null, status: 'active', engines: ['booking'] },
];
