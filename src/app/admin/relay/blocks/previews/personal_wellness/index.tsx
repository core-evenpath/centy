...
const PW_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'membership_tier', family: 'pricing', label: 'Membership Plans', stage: 'showcase', desc: 'Tier comparison with perks, pricing, best-value badge', preview: MiniMembershipTier, intents: ['membership', 'plans', 'subscribe', 'monthly', 'unlimited'], module: null, status: 'active' },
  ...
  { id: 'loyalty_progress', family: 'retention', label: 'Loyalty / Rewards', stage: 'social_proof', desc: 'Points progress bar, tier status, visit count, rewards earned', preview: MiniLoyaltyProgress, intents: ['rewards', 'points', 'loyalty', 'membership status', 'tier'], module: null, status: 'active' },
