...
const PW_BLOCKS: VerticalBlockDef[] = [
  { id: 'pw_service_card', family: 'catalog', label: 'Service Card', stage: 'discovery', desc: 'Treatment/service with duration, category, pricing, booking count', preview: MiniServiceCard, intents: ['services', 'treatments', 'what do you offer', 'menu'], module: 'items', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'category'] },
  { id: 'pw_service_detail', family: 'catalog', label: 'Service Detail', stage: 'showcase', desc: 'Full service view with benefits, duration, pressure level, area', preview: MiniServiceDetail, intents: ['details', 'tell me more', 'what is included'], module: 'items', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'category'] },
  ...
  { id: 'stylist_profile', family: 'people', label: 'Stylist / Therapist Profile', stage: 'discovery', desc: 'Staff card with specialties, session count, portfolio link', preview: MiniStylistProfile, intents: ['therapist', 'stylist', 'who', 'team', 'specialist'], module: 'items', status: 'active', reads: ['name', 'description', 'image_url', 'subtitle', 'badges'] },
  ...
  { id: 'spa_package', family: 'marketing', label: 'Spa / Service Package', stage: 'showcase', desc: 'Bundled services with total duration, savings, combined price', preview: MiniPackageBuilder, intents: ['package', 'combo', 'bundle', 'deal', 'spa day'], module: 'items', status: 'active', reads: ['name', 'description', 'image_url'] },
  ...
  { id: 'pw_product_shop', family: 'retail', label: 'Retail Products', stage: 'discovery', desc: 'Skincare/hair product cards with brand, size, pricing', preview: MiniProductShop, intents: ['products', 'shop', 'buy', 'skincare', 'retail', 'serum'], module: 'items', status: 'active', reads: ['name', 'description', 'image_url'] },
