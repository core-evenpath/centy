...
const PW_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'pw_appointment', family: 'booking', label: 'Appointment Booking', stage: 'conversion', desc: 'Staff preference selector, time slot grid, confirmation CTA', preview: MiniAppointmentBooking, intents: ['book', 'appointment', 'schedule', 'available', 'when'], module: null, status: 'active' },
  ...
  { id: 'class_schedule', family: 'scheduling', label: 'Class Schedule', stage: 'discovery', desc: 'Weekly class timetable with instructor, level, spots remaining', preview: MiniClassSchedule, intents: ['classes', 'schedule', 'yoga', 'fitness', 'meditation', 'timetable'], module: null, status: 'active' },
  ...
  { id: 'intake_form', family: 'operations', label: 'Client Intake Form', stage: 'conversion', desc: 'Pre-visit health history, allergies, consent checklist', preview: MiniIntakeForm, intents: ['intake', 'form', 'health history', 'allergies', 'consent', 'waiver'], module: null, status: 'active' },
];
