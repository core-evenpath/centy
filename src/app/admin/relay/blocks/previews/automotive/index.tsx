...
const AUTO_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'auto_service_scheduler', family: 'booking', label: 'Service Scheduler', stage: 'conversion', desc: 'Vehicle + service context, date strip, time grid, drop-off preference', preview: MiniServiceScheduler, intents: ['book service', 'schedule', 'appointment', 'drop off'], module: 'automotive_booking', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url', 'date', 'time', 'service_name'] },
  ...
  { id: 'finance_calc', family: 'pricing', label: 'Finance Calculator', stage: 'showcase', desc: 'Loan/lease/cash calculator with down payment, term, APR, monthly estimate', preview: MiniFinanceCalc, intents: ['finance', 'monthly payment', 'lease', 'loan', 'APR', 'afford'], module: 'automotive_pricing', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'currency'] },
  { id: 'trade_in', family: 'valuation', label: 'Trade-In Estimator', stage: 'conversion', desc: 'Vehicle valuation with KBB range, dealer offer, validity period', preview: MiniTradeIn, intents: ['trade in', 'my car value', 'sell my car', 'exchange'], module: 'automotive_valuation', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'currency'] },
  { id: 'auto_service_tracker', family: 'operations', label: 'Service Tracker', stage: 'social_proof', desc: 'Live 5-step pipeline with ETA and technician notes', preview: MiniServiceTracker, intents: ['status', 'where is my car', 'service update', 'ready'], module: 'automotive_operations', status: 'active', reads: ['name', 'description', 'image_url', 'status', 'last_updated'] },
  { id: 'test_drive', family: 'booking', label: 'Test Drive Booking', stage: 'conversion', desc: 'Vehicle context with stock #, date/time selector, no-obligation badge', preview: MiniTestDrive, intents: ['test drive', 'try', 'drive', 'see in person'], module: 'automotive_booking', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url', 'date', 'time', 'service_name'] },
  { id: 'rental_builder', family: 'pricing', label: 'Rental / Lease Builder', stage: 'showcase', desc: 'Duration selector, insurance add-ons with pricing, total', preview: MiniRentalBuilder, intents: ['rent', 'rental', 'lease', 'hire', 'weekly rate'], module: 'automotive_pricing', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url', 'price', 'currency'] },
  { id: 'warranty', family: 'trust', label: 'Warranty & Coverage', stage: 'showcase', desc: 'Active warranty plans with coverage term, mileage limit, status badges', preview: MiniWarranty, intents: ['warranty', 'coverage', 'protection', 'extended warranty'], module: 'automotive_trust', status: 'active', reads: ['name', 'description', 'image_url', 'badges'] },
  { id: 'fleet_dashboard', family: 'fleet', label: 'Fleet Dashboard', stage: 'social_proof', desc: 'Multi-vehicle status grid with per-vehicle plate/model/driver/status', preview: MiniFleetDashboard, intents: ['fleet', 'vehicles', 'all vehicles', 'fleet status'], module: 'automotive_fleet', status: 'active', reads: ['name', 'description', 'image_url'] },
  { id: 'auto_review', family: 'social_proof', label: 'Customer Reviews', stage: 'social_proof', desc: 'Auto-specific criteria bars, purchase/service-tagged reviews', preview: MiniAutoReview, intents: ['reviews', 'ratings', 'testimonials', 'feedback'], module: 'automotive_social_proof', status: 'active', reads: ['name', 'description', 'image_url', 'rating', 'review_count'] },
  { id: 'ev_charger', family: 'ev', label: 'EV Charging Status', stage: 'discovery', desc: 'Charger availability with station types, power levels, real-time status', preview: MiniEVCharger, intents: ['charging', 'EV', 'electric', 'charger', 'plug in', 'kWh'], module: 'automotive_ev', status: 'active', reads: ['name', 'description', 'image_url'] },
];
