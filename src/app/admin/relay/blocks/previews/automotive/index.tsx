...
const AUTO_BLOCKS: VerticalBlockDef[] = [
  { id: 'vehicle_card', family: 'catalog', label: 'Vehicle Card', stage: 'discovery', desc: 'Vehicle listing with make/model/year, mileage, fuel type, MPG, pricing', preview: MiniVehicleCard, intents: ['cars', 'vehicles', 'browse', 'inventory', 'models'], module: 'moduleItems', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'category'] },
  { id: 'vehicle_detail', family: 'catalog', label: 'Vehicle Detail', stage: 'showcase', desc: 'Full spec sheet with engine, drivetrain, features, CARFAX, monthly estimate', preview: MiniVehicleDetail, intents: ['details', 'specs', 'features', 'about this car'], module: 'moduleItems', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'category'] },
  { id: 'auto_service_menu', family: 'service', label: 'Service Menu', stage: 'discovery', desc: 'Maintenance and repair offerings with labor time, parts, category icons', preview: MiniServiceMenu, intents: ['service', 'repair', 'maintenance', 'oil change', 'brakes', 'tires'], module: 'moduleItems', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'category'] },
  ...
  { id: 'part_finder', family: 'parts', label: 'Part Finder', stage: 'discovery', desc: 'Auto parts with fitment compatibility, OE spec badge, stock status', preview: MiniPartFinder, intents: ['parts', 'accessories', 'tires', 'brake pads', 'oil', 'battery'], module: 'moduleItems', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'category'] },
