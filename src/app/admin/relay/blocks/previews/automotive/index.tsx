...
const AUTO_BLOCKS: VerticalBlockDef[] = [
  { id: 'vehicle_card', family: 'catalog', label: 'Vehicle Card', stage: 'discovery', desc: 'Vehicle listing with make/model/year, mileage, fuel type, MPG, pricing', preview: MiniVehicleCard, intents: ['cars', 'vehicles', 'browse', 'inventory', 'models'], module: 'moduleItems', status: 'active' },
  { id: 'vehicle_detail', family: 'catalog', label: 'Vehicle Detail', stage: 'showcase', desc: 'Full spec sheet with engine, drivetrain, features, CARFAX, monthly estimate', preview: MiniVehicleDetail, intents: ['details', 'specs', 'features', 'about this car'], module: 'moduleItems', status: 'active' },
  { id: 'auto_service_menu', family: 'service', label: 'Service Menu', stage: 'discovery', desc: 'Maintenance and repair offerings with labor time, parts, category icons', preview: MiniServiceMenu, intents: ['service', 'repair', 'maintenance', 'oil change', 'brakes', 'tires'], module: 'moduleItems', status: 'active' },
  { id: 'auto_service_scheduler', family: 'booking', label: 'Service Scheduler', stage: 'conversion', desc: 'Vehicle + service context, date strip, time grid, drop-off preference', preview: MiniServiceScheduler, intents: ['book service', 'schedule', 'appointment', 'drop off'], module: null, status: 'active', engines: ['booking'] },
  { id: 'part_finder', family: 'parts', label: 'Part Finder', stage: 'discovery', desc: 'Auto parts with fitment compatibility, OE spec badge, stock status', preview: MiniPartFinder, intents: ['parts', 'accessories', 'tires', 'brake pads', 'oil', 'battery'], module: 'moduleItems', status: 'active' },
  { id: 'finance_calc', family: 'pricing', label: 'Finance Calculator', stage: 'showcase', desc: 'Loan/lease/cash calculator with down payment, term, APR, monthly estimate', preview: MiniFinanceCalc, intents: ['finance', 'monthly payment', 'lease', 'loan', 'APR', 'afford'], module: null, status: 'active' },
  { id: 'trade_in', family: 'valuation', label: 'Trade-In Estimator', stage: 'conversion', desc: 'Vehicle valuation with KBB range, dealer offer, validity period', preview: MiniTradeIn, intents: ['trade in', 'my car value', 'sell my car', 'exchange'], module: null, status: 'active' },
  { id: 'auto_service_tracker', family: 'operations', label: 'Service Tracker', stage: 'social_proof', desc: 'Live 5-step pipeline with ETA and technician notes', preview: MiniServiceTracker, intents: ['status', 'where is my car', 'service update', 'ready'], module: null, status: 'active' },
  { id: 'test_drive', family: 'booking', label: 'Test Drive Booking', stage: 'conversion', desc: 'Vehicle context with stock #, date/time selector, no-obligation badge', preview: MiniTestDrive, intents: ['test drive', 'try', 'drive', 'see in person'], module: null, status: 'active', engines: ['booking'] },
  { id: 'rental_builder', family: 'pricing', label: 'Rental / Lease Builder', stage: 'showcase', desc: 'Duration selector, insurance add-ons with pricing, total', preview: MiniRentalBuilder, intents: ['rent', 'rental', 'lease', 'hire', 'weekly rate'], module: null, status: 'active', engines: ['booking'] },
  { id: 'warranty', family: 'trust', label: 'Warranty & Coverage', stage: 'showcase', desc: 'Active warranty plans with coverage term, mileage limit, status badges', preview: MiniWarranty, intents: ['warranty', 'coverage', 'protection', 'extended warranty'], module: null, status: 'active' },
  { id: 'fleet_dashboard', family: 'fleet', label: 'Fleet Dashboard', stage: 'social_proof', desc: 'Multi-vehicle status grid with per-vehicle plate/model/driver/status', preview: MiniFleetDashboard, intents: ['fleet', 'vehicles', 'all vehicles', 'fleet status'], module: null, status: 'active' },
  { id: 'auto_review', family: 'social_proof', label: 'Customer Reviews', stage: 'social_proof', desc: 'Auto-specific criteria bars, purchase/service-tagged reviews', preview: MiniAutoReview, intents: ['reviews', 'ratings', 'testimonials', 'feedback'], module: null, status: 'active' },
  { id: 'ev_charger', family: 'ev', label: 'EV Charging Status', stage: 'discovery', desc: 'Charger availability with station types, power levels, real-time status', preview: MiniEVCharger, intents: ['charging', 'EV', 'electric', 'charger', 'plug in', 'kWh'], module: null, status: 'active' },
];
