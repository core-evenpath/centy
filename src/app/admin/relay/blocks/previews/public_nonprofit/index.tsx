...
const PU_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'pu_service_directory', family: 'services', label: 'Service Directory', stage: 'discovery', desc: 'Government/public services with department tags, processing times, fees', preview: MiniServiceDirectory, intents: ['services', 'departments', 'apply', 'certificate', 'license', 'permit', 'tax'], module: 'moduleItems', status: 'active', engines: ['info'] },
  // engines: ['service'] — track existing application status; pure service overlay
  { id: 'pu_application_tracker', family: 'tracking', label: 'Application Tracker', stage: 'social_proof', desc: 'Multi-step status pipeline with ref number and ETA', preview: MiniApplicationTracker, intents: ['status', 'track', 'application', 'progress', 'reference number'], module: null, status: 'active', engines: ['service'] },
  // engines: ['info', 'engagement'] — info surface for downloading forms; engagement when citizen submits filled form
  { id: 'pu_document_portal', family: 'forms', label: 'Forms & Documents', stage: 'discovery', desc: 'Downloadable and online forms organized by department', preview: MiniDocumentPortal, intents: ['forms', 'documents', 'download', 'application form', 'PDF'], module: 'moduleItems', status: 'active', engines: ['info', 'engagement'] },
  ...
  { id: 'pu_event_calendar', family: 'community', label: 'Community Events', stage: 'discovery', desc: 'Upcoming public events, meetings, workshops, festivals', preview: MiniEventCalendar, intents: ['events', 'town hall', 'meeting', 'festival', 'workshop', 'calendar'], module: 'moduleItems', status: 'active', engines: ['engagement', 'booking'] },
  // engines: ['engagement'] — in-chat donation commitment; payment processor is partner config, not a block-level engine split
  { id: 'pu_donation', family: 'fundraising', label: 'Donation', stage: 'conversion', desc: 'Preset amount grid, frequency selector, trust badges', preview: MiniDonation, intents: ['donate', 'give', 'support', 'contribute', 'fund', 'charity'], module: null, status: 'active', engines: ['engagement'] },
  // engines: ['engagement'] — post-donation transparency / trust / thank-you content
  { id: 'pu_impact_report', family: 'transparency', label: 'Impact Report', stage: 'social_proof', desc: '3-stat hero grid, key outcomes checklist, next-year goal', preview: MiniImpactReport, intents: ['impact', 'results', 'transparency', 'annual report', 'outcomes'], module: null, status: 'active', engines: ['engagement'] },
  // engines: ['engagement'] — volunteer signup is in-chat commitment only, never a transaction
  { id: 'pu_volunteer', family: 'community', label: 'Volunteer Sign-up', stage: 'conversion', desc: 'Interest area multi-select, availability selector, sign-up CTA', preview: MiniVolunteerSignup, intents: ['volunteer', 'help', 'sign up', 'join', 'community service'], module: null, status: 'active', engines: ['engagement'] },
  // engines: ['engagement'] — program-card discovery for nonprofit categories (mission, causes)
  { id: 'pu_program_card', family: 'programs', label: 'Program Card', stage: 'discovery', desc: 'Active programs with status, budget, progress bar', preview: MiniProgramCard, intents: ['programs', 'initiatives', 'projects', 'mission', 'causes'], module: 'moduleItems', status: 'active', engines: ['engagement'] },
  // engines: ['commerce'] — bill payment is a transaction
  { id: 'pu_bill_pay', family: 'billing', label: 'Bill Payment', stage: 'conversion', desc: 'Account context, line-item breakdown, total due, pay CTA', preview: MiniBillPay, intents: ['pay bill', 'payment', 'account', 'balance', 'utility bill', 'water bill'], module: null, status: 'active', engines: ['commerce'] },
  // engines: ['info'] — utility operational status display
  { id: 'pu_outage_status', family: 'operations', label: 'Service Status', stage: 'social_proof', desc: 'Live status per utility with operational/maintenance/delayed indicators', preview: MiniOutageStatus, intents: ['outage', 'status', 'service down', 'maintenance', 'power'], module: null, status: 'active', engines: ['info'] },
  // engines: ['engagement'] — community engagement pattern (request / complaint filing)
  { id: 'pu_complaint', family: 'engagement', label: 'Request / Complaint', stage: 'conversion', desc: 'Category selector, subject input, details textarea, submit CTA', preview: MiniComplaintFiling, intents: ['report', 'complaint', 'issue', 'feedback', 'problem', 'pothole'], module: null, status: 'active', engines: ['engagement'] },
  // engines: ['info'] — pure info surface (where / hours / address)
  { id: 'pu_office_locator', family: 'info', label: 'Office Locator', stage: 'discovery', desc: 'Location list with address, hours, open/closed status', preview: MiniOfficeLocator, intents: ['office', 'location', 'where', 'address', 'hours', 'directions'], module: null, status: 'active', engines: ['info'] },
  // engines: ['booking'] — appointment scheduling at government office
  { id: 'pu_appointment', family: 'booking', label: 'Appointment Scheduler', stage: 'conversion', desc: 'Department selector, date strip, time grid, confirmation CTA', preview: MiniAppointmentBooker, intents: ['appointment', 'book', 'schedule', 'visit', 'in person'], module: null, status: 'active', engines: ['booking'] },
  // engines: ['engagement'] — community feedback / satisfaction ratings for engagement partners
  { id: 'pu_feedback', family: 'social_proof', label: 'Community Feedback', stage: 'social_proof', desc: 'Public-sector criteria bars, department-tagged feedback', preview: MiniCommunityFeedback, intents: ['reviews', 'feedback', 'satisfaction', 'ratings', 'citizen feedback'], module: null, status: 'active', engines: ['engagement'] },
];
