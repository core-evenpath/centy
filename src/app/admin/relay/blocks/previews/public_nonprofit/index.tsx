...
const PU_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'pu_service_directory', family: 'services', label: 'Service Directory', stage: 'discovery', desc: 'Government/public services with department tags, processing times, fees', preview: MiniServiceDirectory, intents: ['services', 'departments', 'apply', 'certificate', 'license', 'permit', 'tax'], module: 'items', status: 'active', engines: ['info'], reads: ['name', 'description', 'image_url'] },
  ...
  { id: 'pu_document_portal', family: 'forms', label: 'Forms & Documents', stage: 'discovery', desc: 'Downloadable and online forms organized by department', preview: MiniDocumentPortal, intents: ['forms', 'documents', 'download', 'application form', 'PDF'], module: 'items', status: 'active', engines: ['info', 'engagement'], reads: ['name', 'description', 'image_url'] },
  ...
  { id: 'pu_event_calendar', family: 'community', label: 'Community Events', stage: 'discovery', desc: 'Upcoming public events, meetings, workshops, festivals', preview: MiniEventCalendar, intents: ['events', 'town hall', 'meeting', 'festival', 'workshop', 'calendar'], module: 'items', status: 'active', engines: ['engagement', 'booking'], reads: ['name', 'description', 'image_url'] },
  ...
  { id: 'pu_program_card', family: 'programs', label: 'Program Card', stage: 'discovery', desc: 'Active programs with status, budget, progress bar', preview: MiniProgramCard, intents: ['programs', 'initiatives', 'projects', 'mission', 'causes'], module: 'items', status: 'active', engines: ['engagement'], reads: ['name', 'description', 'image_url'] },
