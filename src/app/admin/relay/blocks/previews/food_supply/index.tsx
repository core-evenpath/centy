...
const FS_BLOCKS: VerticalBlockDef[] = [
  { id: 'fs_product_card', family: 'catalog', label: 'Product Card', stage: 'discovery', desc: 'Wholesale product with origin, unit size, MOQ, SKU, certification badges', preview: MiniProductCard, intents: ['products', 'items', 'catalog', 'browse', 'inventory'], module: 'items', status: 'active', engines: ['commerce'], reads: ['name', 'description', 'image_url', 'price', 'category'] },
  { id: 'fs_product_detail', family: 'catalog', label: 'Product Detail', stage: 'showcase', desc: 'Full spec sheet with case size, shelf life, storage temp, grade, tier pricing', preview: MiniProductDetail, intents: ['details', 'specs', 'tell me more', 'shelf life', 'storage'], module: 'items', status: 'active', engines: ['commerce'], reads: ['name', 'description', 'image_url', 'price', 'category'] },
