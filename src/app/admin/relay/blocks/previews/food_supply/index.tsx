...
const FS_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'cert_compliance', family: 'trust', label: 'Certifications', stage: 'social_proof', desc: 'Food safety cert list with issuing body, ID, expiry, status', preview: MiniCertCompliance, intents: ['certifications', 'organic', 'HACCP', 'halal', 'food safety'], module: 'food_supply_trust', status: 'active', engines: ['commerce'], reads: ['name', 'description', 'image_url', 'badges', 'rating', 'review_count', 'subtitle'] },
