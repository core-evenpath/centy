...
const FS_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'fs_order_tracker', family: 'logistics', label: 'Order Tracker', stage: 'social_proof', desc: 'Multi-step delivery pipeline with timestamps and ETA', preview: MiniOrderTracker, intents: ['track', 'where is my order', 'delivery status', 'ETA', 'shipment'], module: null, status: 'active' },
