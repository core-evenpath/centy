...
const FS_BLOCKS: VerticalBlockDef[] = [
  { id: 'fs_product_card', family: 'catalog', label: 'Product Card', stage: 'discovery', desc: 'Wholesale product with origin, unit size, MOQ, SKU, certification badges', preview: MiniProductCard, intents: ['products', 'items', 'catalog', 'browse', 'inventory'], module: 'moduleItems', status: 'active' },
  { id: 'fs_product_detail', family: 'catalog', label: 'Product Detail', stage: 'showcase', desc: 'Full spec sheet with case size, shelf life, storage temp, grade, tier pricing', preview: MiniProductDetail, intents: ['details', 'specs', 'tell me more', 'shelf life', 'storage'], module: 'moduleItems', status: 'active' },
  { id: 'catalog_browser', family: 'catalog', label: 'Catalog Browser', stage: 'discovery', desc: 'Category grid with SKU counts per category', preview: MiniCatalogBrowser, intents: ['categories', 'browse', 'catalog', 'sections', 'product types'], module: null, status: 'active' },
  { id: 'bulk_order', family: 'ordering', label: 'Bulk Order Builder', stage: 'conversion', desc: 'Multi-item quantity builder with tier pricing and subtotal', preview: MiniBulkOrderBuilder, intents: ['order', 'buy', 'purchase', 'bulk', 'quantities', 'reorder'], module: null, status: 'active' },
  { id: 'supplier_profile', family: 'trust', label: 'Supplier Profile', stage: 'discovery', desc: 'Farm/distributor card with certifications, product categories, buyer count', preview: MiniSupplierProfile, intents: ['supplier', 'farm', 'grower', 'who supplies', 'distributor'], module: 'moduleItems', status: 'active' },
  { id: 'wholesale_pricing', family: 'pricing', label: 'Wholesale Pricing', stage: 'showcase', desc: 'Tiered pricing table with volume brackets and percentage savings', preview: MiniWholesalePricing, intents: ['pricing', 'wholesale', 'volume discount', 'bulk price', 'cost'], module: null, status: 'active' },
  { id: 'delivery_scheduler', family: 'logistics', label: 'Delivery Scheduler', stage: 'conversion', desc: 'Date/time window picker with cold chain toggle', preview: MiniDeliveryScheduler, intents: ['delivery', 'schedule', 'when', 'ship', 'logistics', 'cold chain'], module: null, status: 'active' },
  ...
  { id: 'cert_compliance', family: 'trust', label: 'Certifications', stage: 'social_proof', desc: 'Food safety cert list with issuing body, ID, expiry, status', preview: MiniCertCompliance, intents: ['certifications', 'organic', 'HACCP', 'halal', 'food safety'], module: null, status: 'active' },
  { id: 'stock_status', family: 'inventory', label: 'Stock Availability', stage: 'discovery', desc: 'Real-time stock levels with fill bars and restock ETA', preview: MiniStockStatus, intents: ['stock', 'available', 'in stock', 'inventory', 'out of stock'], module: null, status: 'active' },
  { id: 'sample_request', family: 'sales', label: 'Sample Request', stage: 'conversion', desc: 'Product sample selector with free-for-qualified-buyers badge', preview: MiniSampleRequest, intents: ['sample', 'try', 'taste', 'test', 'free sample', 'trial'], module: null, status: 'active' },
  { id: 'quality_report', family: 'quality', label: 'Quality Report', stage: 'social_proof', desc: 'Batch inspection results with pass/fail indicators, COA download', preview: MiniQualityReport, intents: ['quality', 'lab report', 'inspection', 'COA', 'test results'], module: null, status: 'active' },
  { id: 'recurring_order', family: 'ordering', label: 'Standing Orders', stage: 'social_proof', desc: 'Subscription-style order manager with frequency and next delivery', preview: MiniRecurringOrder, intents: ['recurring', 'standing order', 'subscription', 'auto order', 'weekly'], module: null, status: 'active' },
  { id: 'buyer_review', family: 'social_proof', label: 'Buyer Reviews', stage: 'social_proof', desc: 'B2B reviews with supply-chain criteria bars', preview: MiniBuyerReview, intents: ['reviews', 'ratings', 'feedback', 'testimonials', 'references'], module: null, status: 'active' },
];
