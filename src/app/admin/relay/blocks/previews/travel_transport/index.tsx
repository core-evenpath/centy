...
const TL_BLOCKS: VerticalBlockDef[] = [
  { id: 'tour_package', family: 'catalog', label: 'Tour / Trip Package', stage: 'discovery', desc: 'Travel package with destination, duration, category, pricing, ratings', preview: MiniTourPackage, intents: ['tours', 'trips', 'packages', 'destinations', 'vacation'], module: 'moduleItems', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'category'] },
  { id: 'tl_itinerary', family: 'catalog', label: 'Day-by-Day Itinerary', stage: 'showcase', desc: 'Visual timeline with day ranges, locations, activities, total pricing', preview: MiniItinerary, intents: ['itinerary', 'day by day', 'plan', 'schedule', 'activities'], module: 'moduleItems', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'category'] },
  ...
  { id: 'destination_card', family: 'catalog', label: 'Destination Card', stage: 'discovery', desc: 'Destination spotlight with best season, starting price, photo grid', preview: MiniDestinationCard, intents: ['destinations', 'where to go', 'suggest', 'recommend', 'popular'], module: 'moduleItems', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'category'] },
