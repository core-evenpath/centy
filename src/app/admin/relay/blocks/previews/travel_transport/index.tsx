...
const TL_BLOCKS: VerticalBlockDef[] = [
  { id: 'tour_package', family: 'catalog', label: 'Tour / Trip Package', stage: 'discovery', desc: 'Travel package with destination, duration, category, pricing, ratings', preview: MiniTourPackage, intents: ['tours', 'trips', 'packages', 'destinations', 'vacation'], module: 'items', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'category'] },
  { id: 'tl_itinerary', family: 'catalog', label: 'Day-by-Day Itinerary', stage: 'showcase', desc: 'Visual timeline with day ranges, locations, activities, total pricing', preview: MiniItinerary, intents: ['itinerary', 'day by day', 'plan', 'schedule', 'activities'], module: 'items', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'category'] },
  { id: 'visa_tracker', family: 'documents', label: 'Visa Application Tracker', stage: 'social_proof', desc: 'Multi-step application pipeline with ref number and ETA', preview: MiniVisaTracker, intents: ['visa', 'application', 'status', 'immigration', 'passport'], module: null, status: 'active', noModuleReason: 'ai_generated' },
  { id: 'ticket_booking', family: 'booking', label: 'Ticket / Flight Booking', stage: 'conversion', desc: 'Route header, flight/bus options with airline, times, stops, price comparison', preview: MiniTicketBooking, intents: ['flights', 'tickets', 'book', 'fare', 'airline', 'bus', 'train'], module: null, status: 'active', engines: ['booking'], noModuleReason: 'checkout' },
  { id: 'ride_estimate', family: 'rides', label: 'Ride Estimate', stage: 'showcase', desc: 'Vehicle tier radio with ETA, capacity, per-ride pricing', preview: MiniRideEstimate, intents: ['ride', 'taxi', 'cab', 'transfer', 'pickup'], module: null, status: 'active', noModuleReason: 'ai_generated' },
  { id: 'tl_shipment_tracker', family: 'logistics', label: 'Shipment Tracker', stage: 'social_proof', desc: '5-step delivery pipeline with live timestamps and ETA', preview: MiniShipmentTracker, intents: ['track', 'shipment', 'package', 'delivery status', 'tracking'], module: null, status: 'active', noModuleReason: 'ai_generated' },
  { id: 'tl_quote_builder', family: 'logistics', label: 'Quote / Rate Calculator', stage: 'conversion', desc: 'Service type selector, route, weight, speed tiers with pricing', preview: MiniQuoteBuilder, intents: ['quote', 'rate', 'cost', 'shipping rate', 'estimate'], module: null, status: 'active', noModuleReason: 'ai_generated' },
  { id: 'tl_document_checklist', family: 'documents', label: 'Document Checklist', stage: 'conversion', desc: 'Required document list with uploaded/pending states and upload action', preview: MiniDocumentChecklist, intents: ['documents', 'upload', 'requirements', 'paperwork'], module: null, status: 'active', noModuleReason: 'ai_generated' },
  ...
  { id: 'tl_schedule_grid', family: 'timetable', label: 'Schedule / Timetable', stage: 'showcase', desc: 'Multi-operator schedule with departure/arrival, seat availability, pricing', preview: MiniScheduleGrid, intents: ['schedule', 'timetable', 'departures', 'next bus', 'next train'], module: null, status: 'active', engines: ['booking', 'info'], noModuleReason: 'checkout' },
  { id: 'travel_insurance', family: 'protection', label: 'Travel Insurance', stage: 'showcase', desc: 'Coverage tier radio with details, limits, recommended badge', preview: MiniTravelInsurance, intents: ['insurance', 'coverage', 'protection', 'travel insurance'], module: null, status: 'active', noModuleReason: 'ai_generated' },
  { id: 'transfer_booking', family: 'booking', label: 'Airport Transfer', stage: 'conversion', desc: 'Flight context, vehicle tier selector, meet-and-greet badges', preview: MiniTransferBooking, intents: ['airport transfer', 'pickup', 'chauffeur', 'meet and greet'], module: null, status: 'active', engines: ['booking'], noModuleReason: 'checkout' },
  { id: 'traveler_review', family: 'social_proof', label: 'Traveler Reviews', stage: 'social_proof', desc: 'Travel-specific criteria bars, trip-tagged reviews', preview: MiniTravelerReview, intents: ['reviews', 'ratings', 'testimonials', 'feedback'], module: null, status: 'active', noModuleReason: 'design_only' },
  { id: 'destination_card', family: 'catalog', label: 'Destination Card', stage: 'discovery', desc: 'Destination spotlight with best season, starting price, photo grid', preview: MiniDestinationCard, intents: ['destinations', 'where to go', 'suggest', 'recommend', 'popular'], module: 'items', status: 'active', reads: ['name', 'description', 'image_url', 'price', 'category'] },
  { id: 'moving_estimate', family: 'logistics', label: 'Moving Estimate', stage: 'showcase', desc: 'Room/item inventory, distance, packing add-ons, total estimate', preview: MiniMovingEstimate, intents: ['moving', 'relocation', 'movers', 'packing', 'long distance'], module: null, status: 'active', noModuleReason: 'ai_generated' },
];
