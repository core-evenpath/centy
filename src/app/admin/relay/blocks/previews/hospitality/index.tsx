...
const HOSP_BLOCKS: VerticalBlockDef[] = [
  { id: 'room_card', family: 'rooms', label: 'Room / Unit Card', stage: 'discovery', desc: 'Browsable room card with bed type, rate, occupancy, amenities', preview: MiniRoomCard, intents: ['rooms', 'browse', 'availability', 'stay'], module: 'moduleItems', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url'] },
  { id: 'room_detail', family: 'rooms', label: 'Room Detail', stage: 'showcase', desc: 'Full room view with gallery, amenities grid, policies, booking CTA', preview: MiniRoomDetail, intents: ['details', 'tell me more', 'room info'], module: 'moduleItems', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url'] },
  ...
  { id: 'amenities', family: 'property', label: 'Amenities Grid', stage: 'discovery', desc: 'Grouped property amenities -- room, property, services', preview: MiniAmenities, intents: ['amenities', 'facilities', 'pool', 'gym', 'spa'], module: 'moduleItems', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url'] },
  ...
  { id: 'local_experiences', family: 'concierge', label: 'Local Experiences', stage: 'discovery', desc: 'Nearby tours, activities, and excursions with booking', preview: MiniLocalExperiences, intents: ['things to do', 'activities', 'tours'], module: 'moduleItems', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url'] },
  { id: 'venue_space', family: 'events', label: 'Venue / Event Space', stage: 'showcase', desc: 'Event venue with capacity, layouts, AV equipment', preview: MiniVenueSpace, intents: ['event', 'wedding', 'conference', 'venue'], module: 'moduleItems', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url'] },
  { id: 'camping_unit', family: 'rooms', label: 'Camping / Glamping', stage: 'discovery', desc: 'Tent, cabin, or glamping unit with outdoor amenities', preview: MiniCampingUnit, intents: ['tent', 'cabin', 'glamping'], module: 'moduleItems', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url'] },
