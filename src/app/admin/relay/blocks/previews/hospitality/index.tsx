...
const HOSP_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'availability', family: 'booking', label: 'Availability Calendar', stage: 'showcase', desc: 'Date picker with nightly rates and stay total', preview: MiniAvailability, intents: ['dates', 'available', 'when', 'calendar'], module: 'hospitality_booking', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url', 'date', 'time', 'service_name', 'status', 'duration', 'location', 'price', 'currency', 'attendee_name'] },
  ...
  { id: 'meal_plan', family: 'dining', label: 'Meal Plan Selector', stage: 'showcase', desc: 'RO / BB / HB / AI meal plan radio selector with pricing', preview: MiniMealPlan, intents: ['meals', 'breakfast', 'dinner', 'all inclusive'], module: 'hospitality_dining', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url'] },
  { id: 'guest_review', family: 'social_proof', label: 'Guest Reviews', stage: 'social_proof', desc: 'Scored guest reviews with category breakdowns', preview: MiniGuestReview, intents: ['reviews', 'rating', 'feedback'], module: 'hospitality_social_proof', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url', 'rating', 'review_count', 'subtitle', 'badges', 'author', 'verified', 'date'] },
  { id: 'check_in', family: 'operations', label: 'Digital Check-in', stage: 'conversion', desc: 'Pre-arrival check-in form with ID, arrival time, add-ons', preview: MiniCheckIn, intents: ['check in', 'arrive', 'pre-check'], module: 'hospitality_operations', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url', 'status', 'last_updated', 'progress', 'assignee', 'priority'] },
  { id: 'property_gallery', family: 'property', label: 'Property Gallery', stage: 'discovery', desc: 'Photo grid of property areas', preview: MiniPropertyGallery, intents: ['photos', 'pictures', 'gallery'], module: 'hospitality_property', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url'] },
  ...
  { id: 'house_rules', family: 'property', label: 'House Rules & Policies', stage: 'objection', desc: 'Check-in/out times, cancellation, pets, children, quiet hours', preview: MiniHouseRules, intents: ['rules', 'policy', 'cancellation', 'pets'], module: 'hospitality_property', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url'] },
  { id: 'concierge', family: 'concierge', label: 'Concierge Request', stage: 'conversion', desc: 'In-stay service request -- room service, spa, taxi', preview: MiniConcierge, intents: ['room service', 'concierge', 'request'], module: 'hospitality_concierge', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url'] },
  { id: 'transfer', family: 'transport', label: 'Airport Transfer', stage: 'conversion', desc: 'Vehicle type selector for airport pickup with pricing', preview: MiniTransfer, intents: ['transfer', 'airport', 'pickup', 'shuttle'], module: 'hospitality_transport', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url'] },
];
