...
const HOSP_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'availability', family: 'booking', label: 'Availability Calendar', stage: 'showcase', desc: 'Date picker with nightly rates and stay total', preview: MiniAvailability, intents: ['dates', 'available', 'when', 'calendar'], module: 'hospitality_booking', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url', 'date', 'time', 'service_name'] },
  ...
  { id: 'guest_review', family: 'social_proof', label: 'Guest Reviews', stage: 'social_proof', desc: 'Scored guest reviews with category breakdowns', preview: MiniGuestReview, intents: ['reviews', 'rating', 'feedback'], module: 'hospitality_social_proof', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url', 'rating', 'review_count'] },
  { id: 'check_in', family: 'operations', label: 'Digital Check-in', stage: 'conversion', desc: 'Pre-arrival check-in form with ID, arrival time, add-ons', preview: MiniCheckIn, intents: ['check in', 'arrive', 'pre-check'], module: 'hospitality_operations', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url', 'status', 'last_updated'] },
