...
const HOSP_BLOCKS: VerticalBlockDef[] = [
  { id: 'room_card', family: 'rooms', label: 'Room / Unit Card', stage: 'discovery', desc: 'Browsable room card with bed type, rate, occupancy, amenities', preview: MiniRoomCard, intents: ['rooms', 'browse', 'availability', 'stay'], module: 'moduleItems', status: 'active', engines: ['booking'] },
  { id: 'room_detail', family: 'rooms', label: 'Room Detail', stage: 'showcase', desc: 'Full room view with gallery, amenities grid, policies, booking CTA', preview: MiniRoomDetail, intents: ['details', 'tell me more', 'room info'], module: 'moduleItems', status: 'active', engines: ['booking'] },
  { id: 'availability', family: 'booking', label: 'Availability Calendar', stage: 'showcase', desc: 'Date picker with nightly rates and stay total', preview: MiniAvailability, intents: ['dates', 'available', 'when', 'calendar'], module: null, status: 'active', engines: ['booking'] },
  { id: 'amenities', family: 'property', label: 'Amenities Grid', stage: 'discovery', desc: 'Grouped property amenities -- room, property, services', preview: MiniAmenities, intents: ['amenities', 'facilities', 'pool', 'gym', 'spa'], module: 'moduleItems', status: 'active', engines: ['booking'] },
  { id: 'meal_plan', family: 'dining', label: 'Meal Plan Selector', stage: 'showcase', desc: 'RO / BB / HB / AI meal plan radio selector with pricing', preview: MiniMealPlan, intents: ['meals', 'breakfast', 'dinner', 'all inclusive'], module: null, status: 'active', engines: ['booking'] },
  { id: 'guest_review', family: 'social_proof', label: 'Guest Reviews', stage: 'social_proof', desc: 'Scored guest reviews with category breakdowns', preview: MiniGuestReview, intents: ['reviews', 'rating', 'feedback'], module: null, status: 'active', engines: ['booking'] },
  { id: 'check_in', family: 'operations', label: 'Digital Check-in', stage: 'conversion', desc: 'Pre-arrival check-in form with ID, arrival time, add-ons', preview: MiniCheckIn, intents: ['check in', 'arrive', 'pre-check'], module: null, status: 'active', engines: ['booking'] },
  { id: 'property_gallery', family: 'property', label: 'Property Gallery', stage: 'discovery', desc: 'Photo grid of property areas', preview: MiniPropertyGallery, intents: ['photos', 'pictures', 'gallery'], module: null, status: 'active', engines: ['booking'] },
  { id: 'local_experiences', family: 'concierge', label: 'Local Experiences', stage: 'discovery', desc: 'Nearby tours, activities, and excursions with booking', preview: MiniLocalExperiences, intents: ['things to do', 'activities', 'tours'], module: 'moduleItems', status: 'active', engines: ['booking'] },
  { id: 'venue_space', family: 'events', label: 'Venue / Event Space', stage: 'showcase', desc: 'Event venue with capacity, layouts, AV equipment', preview: MiniVenueSpace, intents: ['event', 'wedding', 'conference', 'venue'], module: 'moduleItems', status: 'active', engines: ['booking'] },
  { id: 'camping_unit', family: 'rooms', label: 'Camping / Glamping', stage: 'discovery', desc: 'Tent, cabin, or glamping unit with outdoor amenities', preview: MiniCampingUnit, intents: ['tent', 'cabin', 'glamping'], module: 'moduleItems', status: 'active', engines: ['booking'] },
  { id: 'house_rules', family: 'property', label: 'House Rules & Policies', stage: 'objection', desc: 'Check-in/out times, cancellation, pets, children, quiet hours', preview: MiniHouseRules, intents: ['rules', 'policy', 'cancellation', 'pets'], module: null, status: 'active', engines: ['booking'] },
  { id: 'concierge', family: 'concierge', label: 'Concierge Request', stage: 'conversion', desc: 'In-stay service request -- room service, spa, taxi', preview: MiniConcierge, intents: ['room service', 'concierge', 'request'], module: null, status: 'active', engines: ['booking'] },
  { id: 'transfer', family: 'transport', label: 'Airport Transfer', stage: 'conversion', desc: 'Vehicle type selector for airport pickup with pricing', preview: MiniTransfer, intents: ['transfer', 'airport', 'pickup', 'shuttle'], module: null, status: 'active', engines: ['booking'] },
];
