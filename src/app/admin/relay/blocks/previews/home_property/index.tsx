...
const HP_BLOCKS: VerticalBlockDef[] = [
  { id: 'hp_service_card', family: 'catalog', label: 'Service Card', stage: 'discovery', desc: 'Home service with category, duration, starting price, booking count', preview: MiniServiceCard, intents: ['services', 'plumbing', 'electrical', 'cleaning', 'repair', 'install'], module: 'moduleItems', status: 'active' },
  { id: 'hp_category_browser', family: 'catalog', label: 'Category Browser', stage: 'discovery', desc: 'Visual grid of home service categories with service counts', preview: MiniCategoryBrowser, intents: ['categories', 'browse', 'what do you offer', 'types'], module: null, status: 'active' },
  { id: 'hp_technician', family: 'people', label: 'Technician Profile', stage: 'discovery', desc: 'Skilled worker card with license, specialties, job count, rating', preview: MiniTechnicianCard, intents: ['technician', 'plumber', 'electrician', 'who', 'team'], module: 'moduleItems', status: 'active' },
  { id: 'hp_estimate', family: 'pricing', label: 'Estimate Builder', stage: 'showcase', desc: 'Line-item cost breakdown with labor, parts, total, approve/revise actions', preview: MiniEstimateBuilder, intents: ['estimate', 'quote', 'how much', 'cost', 'pricing', 'budget'], module: null, status: 'active' },
  { id: 'hp_scheduler', family: 'booking', label: 'Job Scheduler', stage: 'conversion', desc: 'Date strip, time window selector, confirmation CTA', preview: MiniJobScheduler, intents: ['schedule', 'book', 'appointment', 'when', 'available'], module: null, status: 'active' },
  { id: 'hp_job_tracker', family: 'operations', label: 'Job Tracker', stage: 'social_proof', desc: 'Live 5-step pipeline with technician ETA', preview: MiniJobTracker, intents: ['status', 'where is technician', 'ETA', 'progress', 'tracking'], module: null, status: 'active' },
  { id: 'hp_before_after', family: 'proof', label: 'Before / After Gallery', stage: 'social_proof', desc: 'Side-by-side project photos with category tag and duration', preview: MiniBeforeAfter, intents: ['results', 'before after', 'portfolio', 'past work', 'gallery'], module: null, status: 'active' },
  { id: 'hp_service_request', family: 'intake', label: 'Service Request', stage: 'conversion', desc: 'Type selector, photo upload prompt, description, submit CTA', preview: MiniServiceRequest, intents: ['request', 'report', 'fix', 'broken', 'need help', 'issue'], module: null, status: 'active' },
  { id: 'hp_maintenance_plan', family: 'subscription', label: 'Maintenance Plan', stage: 'showcase', desc: 'Tier comparison with visit frequency, response time, parts coverage', preview: MiniMaintenancePlan, intents: ['maintenance', 'plan', 'subscription', 'monthly', 'annual', 'preventive'], module: null, status: 'active' },
  { id: 'hp_emergency', family: 'urgent', label: 'Emergency Service', stage: 'conversion', desc: 'Emergency types with response times, 24/7 badge, call CTA', preview: MiniEmergencyCard, intents: ['emergency', 'urgent', 'burst pipe', 'gas leak', 'lockout', '24/7'], module: null, status: 'active' },
  { id: 'hp_history', family: 'tracking', label: 'Service History', stage: 'social_proof', desc: 'Past jobs with date, technician, cost, completion status', preview: MiniServiceHistory, intents: ['history', 'past jobs', 'previous', 'records', 'what was done'], module: null, status: 'active' },
  { id: 'hp_warranty', family: 'trust', label: 'Work Guarantee', stage: 'showcase', desc: 'Warranty plans per service type with coverage term and status', preview: MiniWarrantyCard, intents: ['warranty', 'guarantee', 'coverage', 'what is covered'], module: null, status: 'active' },
  { id: 'hp_review', family: 'social_proof', label: 'Customer Reviews', stage: 'social_proof', desc: 'Home-service criteria bars with service-type-tagged reviews', preview: MiniClientReview, intents: ['reviews', 'ratings', 'testimonials', 'feedback'], module: null, status: 'active' },
  {
