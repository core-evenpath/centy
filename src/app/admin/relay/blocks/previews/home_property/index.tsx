...
const HP_BLOCKS: VerticalBlockDef[] = [
  { id: 'hp_service_card', family: 'catalog', label: 'Service Card', stage: 'discovery', desc: 'Home service with category, duration, starting price, booking count', preview: MiniServiceCard, intents: ['services', 'plumbing', 'electrical', 'cleaning', 'repair', 'install'], module: 'items', status: 'active', engines: ['lead', 'booking'], reads: ['name', 'description', 'image_url', 'price', 'category'] },
  ...
  { id: 'hp_technician', family: 'people', label: 'Technician Profile', stage: 'discovery', desc: 'Skilled worker card with license, specialties, job count, rating', preview: MiniTechnicianCard, intents: ['technician', 'plumber', 'electrician', 'who', 'team'], module: 'items', status: 'active', engines: ['lead', 'booking'], reads: ['name', 'description', 'image_url', 'subtitle', 'badges'] },
