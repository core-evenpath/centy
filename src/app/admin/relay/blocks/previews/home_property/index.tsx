...
const HP_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'hp_technician', family: 'people', label: 'Technician Profile', stage: 'discovery', desc: 'Skilled worker card with license, specialties, job count, rating', preview: MiniTechnicianCard, intents: ['technician', 'plumber', 'electrician', 'who', 'team'], module: 'home_property_people', status: 'active', engines: ['lead', 'booking'], reads: ['name', 'description', 'image_url', 'subtitle', 'badges', 'rating', 'review_count', 'specialties', 'years_experience', 'role', 'availability'] },
  { id: 'hp_estimate', family: 'pricing', label: 'Estimate Builder', stage: 'showcase', desc: 'Line-item cost breakdown with labor, parts, total, approve/revise actions', preview: MiniEstimateBuilder, intents: ['estimate', 'quote', 'how much', 'cost', 'pricing', 'budget'], module: 'home_property_pricing', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'price', 'currency', 'subtitle', 'features', 'period'] },
  { id: 'hp_scheduler', family: 'booking', label: 'Job Scheduler', stage: 'conversion', desc: 'Date strip, time window selector, confirmation CTA', preview: MiniJobScheduler, intents: ['schedule', 'book', 'appointment', 'when', 'available'], module: 'home_property_booking', status: 'active', engines: ['lead', 'booking'], reads: ['name', 'description', 'image_url', 'date', 'time', 'service_name', 'status', 'duration', 'location', 'price', 'currency', 'attendee_name'] },
  { id: 'hp_job_tracker', family: 'operations', label: 'Job Tracker', stage: 'social_proof', desc: 'Live 5-step pipeline with technician ETA', preview: MiniJobTracker, intents: ['status', 'where is technician', 'ETA', 'progress', 'tracking'], module: 'home_property_operations', status: 'active', engines: ['service'], reads: ['name', 'description', 'image_url', 'status', 'last_updated', 'progress', 'assignee', 'priority'] },
  { id: 'hp_before_after', family: 'proof', label: 'Before / After Gallery', stage: 'social_proof', desc: 'Side-by-side project photos with category tag and duration', preview: MiniBeforeAfter, intents: ['results', 'before after', 'portfolio', 'past work', 'gallery'], module: 'home_property_proof', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'rating', 'review_count', 'subtitle', 'badges', 'outcome_metric', 'completion_date', 'author'] },
  ...
  { id: 'hp_history', family: 'tracking', label: 'Service History', stage: 'social_proof', desc: 'Past jobs with date, technician, cost, completion status', preview: MiniServiceHistory, intents: ['history', 'past jobs', 'previous', 'records', 'what was done'], module: 'home_property_tracking', status: 'active', engines: ['service'], reads: ['name', 'description', 'image_url', 'status', 'last_updated', 'eta', 'location', 'progress', 'destination'] },
  { id: 'hp_warranty', family: 'trust', label: 'Work Guarantee', stage: 'showcase', desc: 'Warranty plans per service type with coverage term and status', preview: MiniWarrantyCard, intents: ['warranty', 'guarantee', 'coverage', 'what is covered'], module: 'home_property_trust', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'badges', 'rating', 'review_count', 'subtitle'] },
  { id: 'hp_review', family: 'social_proof', label: 'Customer Reviews', stage: 'social_proof', desc: 'Home-service criteria bars with service-type-tagged reviews', preview: MiniClientReview, intents: ['reviews', 'ratings', 'testimonials', 'feedback'], module: 'home_property_social_proof', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'rating', 'review_count', 'subtitle', 'badges', 'author', 'verified', 'date'] },
  {
