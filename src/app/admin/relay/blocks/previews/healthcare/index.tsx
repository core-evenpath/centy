...
const HC_BLOCKS: VerticalBlockDef[] = [
  { id: 'service_card', family: 'services', label: 'Service / Procedure Card', stage: 'discovery', desc: 'Browsable medical service with specialty tag, duration, pricing, insurance indicator', preview: MiniServiceCard, intents: ['services', 'procedures', 'treatments', 'checkup'], module: 'items', status: 'active', reads: ['name', 'description', 'image_url'] },
  { id: 'provider_profile', family: 'providers', label: 'Provider Profile', stage: 'discovery', desc: 'Doctor card with credentials, board certifications, specializations, patient stats', preview: MiniProviderProfile, intents: ['doctor', 'physician', 'provider', 'specialist', 'find a doctor'], module: 'items', status: 'active', reads: ['name', 'description', 'image_url', 'subtitle', 'badges'] },
  ...
  { id: 'pet_profile', family: 'veterinary', label: 'Pet Health Profile', stage: 'showcase', desc: 'Pet card with breed, weight, vaccination timeline -- veterinary only', preview: MiniPetProfile, intents: ['pet', 'dog', 'cat', 'veterinary', 'vet', 'vaccination'], module: 'items', status: 'active', reads: ['name', 'description', 'image_url'] },
];
