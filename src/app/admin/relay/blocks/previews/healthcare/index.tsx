...
const HC_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'appointment', family: 'booking', label: 'Appointment Scheduler', stage: 'conversion', desc: 'Date/time slot picker with provider context, insurance copay preview', preview: MiniAppointment, intents: ['book', 'appointment', 'schedule', 'available', 'when can I come'], module: 'healthcare_booking', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url', 'date', 'time', 'service_name'] },
  ...
  { id: 'facility', family: 'info', label: 'Facility & Departments', stage: 'discovery', desc: 'Department directory with floor, hours, open/closed status, emergency', preview: MiniFacilityInfo, intents: ['location', 'departments', 'hours', 'directions', 'parking'], module: 'healthcare_info', status: 'active', engines: ['info'], reads: ['name', 'description', 'image_url'] },
  { id: 'patient_review', family: 'social_proof', label: 'Patient Reviews', stage: 'social_proof', desc: 'Aggregate score with healthcare-specific criteria, visit-tagged reviews', preview: MiniPatientReview, intents: ['reviews', 'ratings', 'what do patients say', 'testimonials'], module: 'healthcare_social_proof', status: 'active', reads: ['name', 'description', 'image_url', 'rating', 'review_count'] },
