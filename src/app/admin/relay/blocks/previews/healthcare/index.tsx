...
const HC_BLOCKS: VerticalBlockDef[] = [
  { id: 'service_card', family: 'services', label: 'Service / Procedure Card', stage: 'discovery', desc: 'Browsable medical service with specialty tag, duration, pricing, insurance indicator', preview: MiniServiceCard, intents: ['services', 'procedures', 'treatments', 'checkup'], module: 'moduleItems', status: 'active', reads: ['name', 'description', 'image_url'] },
  { id: 'provider_profile', family: 'providers', label: 'Provider Profile', stage: 'discovery', desc: 'Doctor card with credentials, board certifications, specializations, patient stats', preview: MiniProviderProfile, intents: ['doctor', 'physician', 'provider', 'specialist', 'find a doctor'], module: 'moduleItems', status: 'active', reads: ['name', 'description', 'image_url', 'subtitle', 'badges'] },
  { id: 'appointment', family: 'booking', label: 'Appointment Scheduler', stage: 'conversion', desc: 'Date/time slot picker with provider context, insurance copay preview', preview: MiniAppointment, intents: ['book', 'appointment', 'schedule', 'available', 'when can I come'], module: null, status: 'active', engines: ['booking'], noModuleReason: 'checkout' },
  { id: 'symptom_checker', family: 'assessment', label: 'Symptom Assessment', stage: 'discovery', desc: 'Multi-step symptom questionnaire with body region, severity, duration', preview: MiniSymptomChecker, intents: ['symptoms', 'not feeling well', 'pain', 'sick', 'check symptoms'], module: null, status: 'active', noModuleReason: 'ai_generated' },
  { id: 'insurance', family: 'billing', label: 'Insurance Verification', stage: 'showcase', desc: 'Plan lookup showing network status, copay estimate, deductible progress', preview: MiniInsurance, intents: ['insurance', 'coverage', 'copay', 'in network', 'deductible'], module: null, status: 'active', noModuleReason: 'ai_generated' },
  { id: 'lab_results', family: 'records', label: 'Lab Results', stage: 'social_proof', desc: 'Test result table with values, reference ranges, normal/abnormal indicators', preview: MiniLabResults, intents: ['results', 'labs', 'blood work', 'test results'], module: null, status: 'active', noModuleReason: 'ai_generated' },
  { id: 'prescription', family: 'pharmacy', label: 'Prescription Manager', stage: 'social_proof', desc: 'Active medication list with dosage, refill count, renewal status', preview: MiniPrescription, intents: ['prescription', 'medication', 'refill', 'medicine', 'pharmacy'], module: null, status: 'active', noModuleReason: 'ai_generated' },
  { id: 'patient_intake', family: 'operations', label: 'Patient Intake Form', stage: 'conversion', desc: 'Pre-visit registration with medical history, allergy picker', preview: MiniPatientIntake, intents: ['forms', 'intake', 'paperwork', 'new patient', 'register'], module: null, status: 'active', engines: ['booking'], noModuleReason: 'checkout' },
  { id: 'treatment_plan', family: 'care', label: 'Treatment Plan', stage: 'social_proof', desc: 'Step-by-step care timeline with completed/active/upcoming milestones', preview: MiniTreatmentPlan, intents: ['treatment', 'plan', 'next steps', 'follow up', 'care plan'], module: null, status: 'active', noModuleReason: 'ai_generated' },
  { id: 'telehealth', family: 'virtual', label: 'Telehealth Visit', stage: 'conversion', desc: 'Virtual visit launcher with provider info, pre-visit checklist', preview: MiniTelehealth, intents: ['telehealth', 'video visit', 'virtual', 'online appointment'], module: null, status: 'active', engines: ['booking'], noModuleReason: 'checkout' },
  { id: 'wait_time', family: 'operations', label: 'Wait Time Display', stage: 'discovery', desc: 'Live department wait times with queue position, color-coded urgency', preview: MiniWaitTime, intents: ['wait', 'how long', 'queue', 'busy', 'walk in'], module: null, status: 'active', engines: ['booking'], noModuleReason: 'checkout' },
  ...
  { id: 'facility', family: 'info', label: 'Facility & Departments', stage: 'discovery', desc: 'Department directory with floor, hours, open/closed status, emergency', preview: MiniFacilityInfo, intents: ['location', 'departments', 'hours', 'directions', 'parking'], module: null, status: 'active', engines: ['info'], noModuleReason: 'ai_generated' },
  { id: 'patient_review', family: 'social_proof', label: 'Patient Reviews', stage: 'social_proof', desc: 'Aggregate score with healthcare-specific criteria, visit-tagged reviews', preview: MiniPatientReview, intents: ['reviews', 'ratings', 'what do patients say', 'testimonials'], module: null, status: 'active', noModuleReason: 'design_only' },
  { id: 'pet_profile', family: 'veterinary', label: 'Pet Health Profile', stage: 'showcase', desc: 'Pet card with breed, weight, vaccination timeline -- veterinary only', preview: MiniPetProfile, intents: ['pet', 'dog', 'cat', 'veterinary', 'vet', 'vaccination'], module: 'moduleItems', status: 'active', reads: ['name', 'description', 'image_url'] },
];
