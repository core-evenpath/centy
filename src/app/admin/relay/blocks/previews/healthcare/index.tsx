...
const HC_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'appointment', family: 'booking', label: 'Appointment Scheduler', stage: 'conversion', desc: 'Date/time slot picker with provider context, insurance copay preview', preview: MiniAppointment, intents: ['book', 'appointment', 'schedule', 'available', 'when can I come'], module: null, status: 'active' },
  ...
  { id: 'patient_intake', family: 'operations', label: 'Patient Intake Form', stage: 'conversion', desc: 'Pre-visit registration with medical history, allergy picker', preview: MiniPatientIntake, intents: ['forms', 'intake', 'paperwork', 'new patient', 'register'], module: null, status: 'active' },
  ...
  { id: 'telehealth', family: 'virtual', label: 'Telehealth Visit', stage: 'conversion', desc: 'Virtual visit launcher with provider info, pre-visit checklist', preview: MiniTelehealth, intents: ['telehealth', 'video visit', 'virtual', 'online appointment'], module: null, status: 'active' },
  { id: 'wait_time', family: 'operations', label: 'Wait Time Display', stage: 'discovery', desc: 'Live department wait times with queue position, color-coded urgency', preview: MiniWaitTime, intents: ['wait', 'how long', 'queue', 'busy', 'walk in'], module: null, status: 'active' },
  { id: 'facility', family: 'info', label: 'Facility & Departments', stage: 'discovery', desc: 'Department directory with floor, hours, open/closed status, emergency', preview: MiniFacilityInfo, intents: ['location', 'departments', 'hours', 'directions', 'parking'], module: null, status: 'active' },
