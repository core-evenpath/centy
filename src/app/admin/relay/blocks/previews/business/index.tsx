...
const BIZ_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'engagement_timeline', family: 'tracking', label: 'Engagement Timeline', stage: 'social_proof', desc: 'Active project phases with milestone dots, completion status', preview: MiniEngagementTimeline, intents: ['progress', 'status', 'timeline', 'milestones', 'project update'], module: 'business_tracking', status: 'active', engines: ['lead', 'service'], reads: ['name', 'description', 'image_url', 'status', 'last_updated'] },
  { id: 'retainer_status', family: 'tracking', label: 'Retainer Status', stage: 'social_proof', desc: 'Monthly retainer gauge with hours used/remaining, renewal date', preview: MiniRetainerStatus, intents: ['retainer', 'hours', 'usage', 'balance', 'remaining'], module: 'business_tracking', status: 'active', engines: ['lead', 'service'], reads: ['name', 'description', 'image_url', 'status', 'last_updated'] },
  { id: 'credential_badge', family: 'trust', label: 'Credentials & Licenses', stage: 'social_proof', desc: 'Professional license and certification list with status badges', preview: MiniCredentialBadge, intents: ['credentials', 'licenses', 'certifications', 'qualified'], module: 'business_trust', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'badges'] },
  { id: 'document_collector', family: 'operations', label: 'Document Collector', stage: 'conversion', desc: 'Required document checklist with upload status, pending count', preview: MiniDocumentCollector, intents: ['documents', 'upload', 'send files', 'paperwork', 'forms'], module: 'business_operations', status: 'active', engines: ['lead', 'service'], reads: ['name', 'description', 'image_url', 'status', 'last_updated'] },
