...
const BIZ_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'expert_profile', family: 'people', label: 'Expert / Team Profile', stage: 'discovery', desc: 'Professional card with credentials, specialization tags, project count', preview: MiniExpertProfile, intents: ['team', 'consultant', 'lawyer', 'advisor', 'expert'], module: 'business_people', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'subtitle', 'badges'] },
  { id: 'consultation_booking', family: 'booking', label: 'Consultation Booking', stage: 'conversion', desc: 'Discovery call scheduler with topic selector, format picker, time slots', preview: MiniConsultationBooking, intents: ['book', 'consult', 'meeting', 'schedule', 'discovery call'], module: 'business_booking', status: 'active', engines: ['lead'] },
  { id: 'project_scope', family: 'engagement', label: 'Project Scope', stage: 'showcase', desc: 'Scope document with deliverables checklist, timeline, budget estimate', preview: MiniProjectScope, intents: ['scope', 'deliverables', 'timeline', 'project plan', 'SOW'], module: 'business_engagement', status: 'active', engines: ['lead'] },
  { id: 'case_study', family: 'proof', label: 'Case Study / Portfolio', stage: 'social_proof', desc: 'Past engagement with client industry, challenge, result metrics', preview: MiniCaseStudy, intents: ['case study', 'portfolio', 'past work', 'results', 'track record'], module: 'business_proof', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'subtitle'] },
  { id: 'proposal', family: 'engagement', label: 'Proposal Summary', stage: 'conversion', desc: 'Formal engagement proposal with phased pricing, timeline, total fee', preview: MiniProposalSummary, intents: ['proposal', 'quote', 'estimate', 'pricing', 'contract'], module: 'business_engagement', status: 'active', engines: ['lead'] },
  { id: 'engagement_timeline', family: 'tracking', label: 'Engagement Timeline', stage: 'social_proof', desc: 'Active project phases with milestone dots, completion status', preview: MiniEngagementTimeline, intents: ['progress', 'status', 'timeline', 'milestones', 'project update'], module: 'business_tracking', status: 'active', engines: ['lead', 'service'] },
  { id: 'retainer_status', family: 'tracking', label: 'Retainer Status', stage: 'social_proof', desc: 'Monthly retainer gauge with hours used/remaining, renewal date', preview: MiniRetainerStatus, intents: ['retainer', 'hours', 'usage', 'balance', 'remaining'], module: 'business_tracking', status: 'active', engines: ['lead', 'service'] },
  { id: 'credential_badge', family: 'trust', label: 'Credentials & Licenses', stage: 'social_proof', desc: 'Professional license and certification list with status badges', preview: MiniCredentialBadge, intents: ['credentials', 'licenses', 'certifications', 'qualified'], module: 'business_trust', status: 'active', engines: ['lead'] },
  { id: 'document_collector', family: 'operations', label: 'Document Collector', stage: 'conversion', desc: 'Required document checklist with upload status, pending count', preview: MiniDocumentCollector, intents: ['documents', 'upload', 'send files', 'paperwork', 'forms'], module: 'business_operations', status: 'active', engines: ['lead', 'service'] },
  ...
  { id: 'compliance_checklist', family: 'operations', label: 'Compliance Checklist', stage: 'showcase', desc: 'Step-by-step regulatory/legal checklist with progress fraction', preview: MiniComplianceChecklist, intents: ['compliance', 'checklist', 'requirements', 'regulatory'], module: 'business_operations', status: 'active', engines: ['lead'] },
  { id: 'client_review', family: 'proof', label: 'Client Reviews', stage: 'social_proof', desc: 'B2B testimonials with criteria bars and role + company context', preview: MiniClientReview, intents: ['reviews', 'testimonials', 'ratings', 'client feedback'], module: 'business_proof', status: 'active', engines: ['lead'] },
  { id: 'fee_calculator', family: 'pricing', label: 'Fee Calculator', stage: 'showcase', desc: 'Interactive pricing -- select scope items to build estimate', preview: MiniFeeCalculator, intents: ['fees', 'cost', 'pricing', 'how much', 'estimate', 'budget'], module: 'business_pricing', status: 'active', engines: ['lead'] },
];
