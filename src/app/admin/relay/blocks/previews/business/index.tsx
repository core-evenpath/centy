...
const BIZ_BLOCKS: VerticalBlockDef[] = [
  { id: 'service_package', family: 'catalog', label: 'Service Package Card', stage: 'discovery', desc: 'Engagement offering with pricing model, scope summary, client count', preview: MiniServicePackage, intents: ['services', 'offerings', 'packages', 'pricing', 'retainer'], module: 'business_catalog', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'price', 'category', 'currency', 'subtitle', 'rating', 'review_count', 'badges', 'variants', 'sku'] },
  { id: 'expert_profile', family: 'people', label: 'Expert / Team Profile', stage: 'discovery', desc: 'Professional card with credentials, specialization tags, project count', preview: MiniExpertProfile, intents: ['team', 'consultant', 'lawyer', 'advisor', 'expert'], module: 'business_people', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'subtitle', 'badges', 'rating', 'review_count', 'specialties', 'years_experience', 'role', 'availability'] },
  { id: 'consultation_booking', family: 'booking', label: 'Consultation Booking', stage: 'conversion', desc: 'Discovery call scheduler with topic selector, format picker, time slots', preview: MiniConsultationBooking, intents: ['book', 'consult', 'meeting', 'schedule', 'discovery call'], module: 'business_booking', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'date', 'time', 'service_name', 'status', 'duration', 'location', 'price', 'currency', 'attendee_name'] },
  { id: 'project_scope', family: 'engagement', label: 'Project Scope', stage: 'showcase', desc: 'Scope document with deliverables checklist, timeline, budget estimate', preview: MiniProjectScope, intents: ['scope', 'deliverables', 'timeline', 'project plan', 'SOW'], module: 'business_engagement', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'price', 'currency', 'badges', 'rating', 'review_count'] },
  { id: 'case_study', family: 'proof', label: 'Case Study / Portfolio', stage: 'social_proof', desc: 'Past engagement with client industry, challenge, result metrics', preview: MiniCaseStudy, intents: ['case study', 'portfolio', 'past work', 'results', 'track record'], module: 'business_proof', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'subtitle', 'rating', 'review_count', 'badges', 'outcome_metric', 'completion_date', 'author'] },
  { id: 'proposal', family: 'engagement', label: 'Proposal Summary', stage: 'conversion', desc: 'Formal engagement proposal with phased pricing, timeline, total fee', preview: MiniProposalSummary, intents: ['proposal', 'quote', 'estimate', 'pricing', 'contract'], module: 'business_engagement', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'price', 'currency', 'badges', 'rating', 'review_count'] },
  { id: 'engagement_timeline', family: 'tracking', label: 'Engagement Timeline', stage: 'social_proof', desc: 'Active project phases with milestone dots, completion status', preview: MiniEngagementTimeline, intents: ['progress', 'status', 'timeline', 'milestones', 'project update'], module: 'business_tracking', status: 'active', engines: ['lead', 'service'], reads: ['name', 'description', 'image_url', 'status', 'last_updated', 'eta', 'location', 'progress', 'destination'] },
  { id: 'retainer_status', family: 'tracking', label: 'Retainer Status', stage: 'social_proof', desc: 'Monthly retainer gauge with hours used/remaining, renewal date', preview: MiniRetainerStatus, intents: ['retainer', 'hours', 'usage', 'balance', 'remaining'], module: 'business_tracking', status: 'active', engines: ['lead', 'service'], reads: ['name', 'description', 'image_url', 'status', 'last_updated', 'eta', 'location', 'progress', 'destination'] },
  { id: 'credential_badge', family: 'trust', label: 'Credentials & Licenses', stage: 'social_proof', desc: 'Professional license and certification list with status badges', preview: MiniCredentialBadge, intents: ['credentials', 'licenses', 'certifications', 'qualified'], module: 'business_trust', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'badges', 'rating', 'review_count', 'subtitle'] },
  { id: 'document_collector', family: 'operations', label: 'Document Collector', stage: 'conversion', desc: 'Required document checklist with upload status, pending count', preview: MiniDocumentCollector, intents: ['documents', 'upload', 'send files', 'paperwork', 'forms'], module: 'business_operations', status: 'active', engines: ['lead', 'service'], reads: ['name', 'description', 'image_url', 'status', 'last_updated', 'progress', 'assignee', 'priority'] },
  { id: 'property_listing', family: 'real_estate', label: 'Property Listing', stage: 'discovery', desc: 'Commercial/residential listing with area, price per sqft, tour CTA', preview: MiniPropertyListing, intents: ['listing', 'property', 'office', 'space', 'buy', 'rent', 'lease'], module: 'business_real_estate', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'price', 'category', 'currency', 'subtitle', 'badges', 'rating', 'review_count', 'square_feet', 'bedrooms', 'bathrooms', 'address'] },
  { id: 'compliance_checklist', family: 'operations', label: 'Compliance Checklist', stage: 'showcase', desc: 'Step-by-step regulatory/legal checklist with progress fraction', preview: MiniComplianceChecklist, intents: ['compliance', 'checklist', 'requirements', 'regulatory'], module: 'business_operations', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'status', 'last_updated', 'progress', 'assignee', 'priority'] },
  { id: 'client_review', family: 'proof', label: 'Client Reviews', stage: 'social_proof', desc: 'B2B testimonials with criteria bars and role + company context', preview: MiniClientReview, intents: ['reviews', 'testimonials', 'ratings', 'client feedback'], module: 'business_proof', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'rating', 'review_count', 'subtitle', 'badges', 'outcome_metric', 'completion_date', 'author'] },
  { id: 'fee_calculator', family: 'pricing', label: 'Fee Calculator', stage: 'showcase', desc: 'Interactive pricing -- select scope items to build estimate', preview: MiniFeeCalculator, intents: ['fees', 'cost', 'pricing', 'how much', 'estimate', 'budget'], module: 'business_pricing', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'price', 'currency', 'subtitle', 'features', 'period'] },
];
