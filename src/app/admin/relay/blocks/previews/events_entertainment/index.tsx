...
const EVT_BLOCKS: VerticalBlockDef[] = [
  { id: 'evt_service_card', family: 'catalog', label: 'Service Card', stage: 'discovery', desc: 'Event service with category, duration, starting price, booking count', preview: MiniServiceCard, intents: ['services', 'photography', 'videography', 'planning', 'DJ', 'decorator'], module: 'items', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'price', 'category'] },
  ...
  { id: 'vendor_profile', family: 'people', label: 'Vendor Profile', stage: 'discovery', desc: 'Creative professional with specialties, travel radius, event count', preview: MiniVendorProfile, intents: ['who', 'photographer', 'planner', 'DJ', 'artist', 'vendor'], module: 'items', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'subtitle', 'badges'] },
  { id: 'event_package', family: 'packages', label: 'Event Package', stage: 'showcase', desc: 'Bundled service with guest capacity, coverage hours, vendor count, savings', preview: MiniEventPackage, intents: ['packages', 'bundles', 'all inclusive', 'wedding package'], module: 'items', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url'] },
  ...
  { id: 'evt_venue_card', family: 'venues', label: 'Venue Card', stage: 'discovery', desc: 'Event venue with capacity, area, pricing, amenity list, virtual tour CTA', preview: MiniVenueCard, intents: ['venue', 'space', 'hall', 'location', 'capacity', 'banquet', 'garden'], module: 'items', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url'] },
  { id: 'show_listing', family: 'entertainment', label: 'Show Listing', stage: 'discovery', desc: 'Upcoming shows with type tag, date/time, venue, ticket price, seat count', preview: MiniShowListing, intents: ['shows', 'events', 'tickets', 'tonight', 'upcoming', 'performance'], module: 'items', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url'] },
  ...
  { id: 'evt_equipment', family: 'production', label: 'AV & Equipment', stage: 'showcase', desc: 'Audio/visual/lighting catalog with daily rates, availability status', preview: MiniEquipmentList, intents: ['equipment', 'AV', 'sound', 'lighting', 'LED', 'PA system'], module: 'items', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url'] },
