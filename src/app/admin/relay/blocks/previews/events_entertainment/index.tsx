...
const EVT_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'evt_portfolio', family: 'proof', label: 'Portfolio', stage: 'social_proof', desc: 'Project showcase with photo strips, event title, type tag, shot count', preview: MiniPortfolio, intents: ['portfolio', 'past work', 'samples', 'gallery', 'examples'], module: null, status: 'active', engines: ['lead'], noModuleReason: 'design_only' },
  ...
  { id: 'evt_availability', family: 'booking', label: 'Availability Calendar', stage: 'conversion', desc: 'Monthly calendar with open/booked dates for vendor or venue', preview: MiniAvailabilityCalendar, intents: ['available', 'dates', 'when', 'calendar', 'check date', 'book date'], module: null, status: 'active', engines: ['booking'], noModuleReason: 'checkout' },
  { id: 'evt_quote_builder', family: 'pricing', label: 'Custom Quote Builder', stage: 'conversion', desc: 'Event type selector, service checkboxes with pricing, running total', preview: MiniQuoteBuilder, intents: ['quote', 'pricing', 'cost', 'how much', 'estimate', 'custom', 'budget'], module: null, status: 'active', engines: ['lead'], noModuleReason: 'ai_generated' },
  { id: 'evt_timeline', family: 'planning', label: 'Planning Timeline', stage: 'social_proof', desc: 'Multi-phase milestone tracker from consultation to event day', preview: MiniEventTimeline, intents: ['timeline', 'progress', 'planning status', 'milestones', 'checklist'], module: null, status: 'active', engines: ['lead', 'service'], noModuleReason: 'ai_generated' },
  ...
  { id: 'mood_board', family: 'design', label: 'Design Mood Board', stage: 'showcase', desc: 'Visual theme board with color palette, inspiration images, approve/revise', preview: MiniMoodBoard, intents: ['theme', 'design', 'mood board', 'colors', 'style', 'decor'], module: null, status: 'active', engines: ['lead'], noModuleReason: 'ai_generated' },
  ...
  { id: 'evt_client_review', family: 'social_proof', label: 'Client Reviews', stage: 'social_proof', desc: 'Event-specific criteria bars, event-type-tagged reviews', preview: MiniClientReview, intents: ['reviews', 'ratings', 'testimonials', 'feedback'], module: null, status: 'active', engines: ['lead'], noModuleReason: 'design_only' },
  { id: 'seating_chart', family: 'planning', label: 'Seating Layout', stage: 'showcase', desc: 'Table/section assignments with guest counts per zone', preview: MiniSeatingChart, intents: ['seating', 'layout', 'tables', 'arrangement', 'floor plan'], module: null, status: 'active', engines: ['booking'], noModuleReason: 'checkout' },
  ...
  { id: 'invite_rsvp', family: 'management', label: 'RSVP Tracker', stage: 'social_proof', desc: 'Guest list with sent/accepted/declined/pending counts, dietary info', preview: MiniInviteRSVP, intents: ['RSVP', 'guest list', 'invites', 'who is coming', 'headcount', 'dietary'], module: null, status: 'active', engines: ['booking', 'engagement'], noModuleReason: 'checkout' },
];
