...
const EVT_BLOCKS: VerticalBlockDef[] = [
  { id: 'evt_service_card', family: 'catalog', label: 'Service Card', stage: 'discovery', desc: 'Event service with category, duration, starting price, booking count', preview: MiniServiceCard, intents: ['services', 'photography', 'videography', 'planning', 'DJ', 'decorator'], module: 'events_entertainment_catalog', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'price', 'category', 'currency', 'subtitle', 'rating', 'review_count', 'badges', 'variants', 'sku'] },
  { id: 'evt_portfolio', family: 'proof', label: 'Portfolio', stage: 'social_proof', desc: 'Project showcase with photo strips, event title, type tag, shot count', preview: MiniPortfolio, intents: ['portfolio', 'past work', 'samples', 'gallery', 'examples'], module: 'events_entertainment_proof', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'rating', 'review_count', 'subtitle', 'badges', 'outcome_metric', 'completion_date', 'author'] },
  { id: 'vendor_profile', family: 'people', label: 'Vendor Profile', stage: 'discovery', desc: 'Creative professional with specialties, travel radius, event count', preview: MiniVendorProfile, intents: ['who', 'photographer', 'planner', 'DJ', 'artist', 'vendor'], module: 'events_entertainment_people', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'subtitle', 'badges', 'rating', 'review_count', 'specialties', 'years_experience', 'role', 'availability'] },
  { id: 'event_package', family: 'packages', label: 'Event Package', stage: 'showcase', desc: 'Bundled service with guest capacity, coverage hours, vendor count, savings', preview: MiniEventPackage, intents: ['packages', 'bundles', 'all inclusive', 'wedding package'], module: 'events_entertainment_packages', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'price', 'currency', 'badges', 'features', 'duration'] },
  { id: 'evt_availability', family: 'booking', label: 'Availability Calendar', stage: 'conversion', desc: 'Monthly calendar with open/booked dates for vendor or venue', preview: MiniAvailabilityCalendar, intents: ['available', 'dates', 'when', 'calendar', 'check date', 'book date'], module: 'events_entertainment_booking', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url', 'date', 'time', 'service_name', 'status', 'duration', 'location', 'price', 'currency', 'attendee_name'] },
  { id: 'evt_quote_builder', family: 'pricing', label: 'Custom Quote Builder', stage: 'conversion', desc: 'Event type selector, service checkboxes with pricing, running total', preview: MiniQuoteBuilder, intents: ['quote', 'pricing', 'cost', 'how much', 'estimate', 'custom', 'budget'], module: 'events_entertainment_pricing', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'price', 'currency', 'subtitle', 'features', 'period'] },
  { id: 'evt_timeline', family: 'planning', label: 'Planning Timeline', stage: 'social_proof', desc: 'Multi-phase milestone tracker from consultation to event day', preview: MiniEventTimeline, intents: ['timeline', 'progress', 'planning status', 'milestones', 'checklist'], module: 'events_entertainment_planning', status: 'active', engines: ['lead', 'service'], reads: ['name', 'description', 'image_url'] },
  { id: 'evt_venue_card', family: 'venues', label: 'Venue Card', stage: 'discovery', desc: 'Event venue with capacity, area, pricing, amenity list, virtual tour CTA', preview: MiniVenueCard, intents: ['venue', 'space', 'hall', 'location', 'capacity', 'banquet', 'garden'], module: 'events_entertainment_venues', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url', 'price', 'currency', 'badges', 'rating', 'review_count', 'capacity'] },
  { id: 'show_listing', family: 'entertainment', label: 'Show Listing', stage: 'discovery', desc: 'Upcoming shows with type tag, date/time, venue, ticket price, seat count', preview: MiniShowListing, intents: ['shows', 'events', 'tickets', 'tonight', 'upcoming', 'performance'], module: 'events_entertainment_entertainment', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url', 'price', 'currency', 'badges', 'rating', 'review_count', 'date'] },
  { id: 'mood_board', family: 'design', label: 'Design Mood Board', stage: 'showcase', desc: 'Visual theme board with color palette, inspiration images, approve/revise', preview: MiniMoodBoard, intents: ['theme', 'design', 'mood board', 'colors', 'style', 'decor'], module: 'events_entertainment_design', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url'] },
  { id: 'evt_equipment', family: 'production', label: 'AV & Equipment', stage: 'showcase', desc: 'Audio/visual/lighting catalog with daily rates, availability status', preview: MiniEquipmentList, intents: ['equipment', 'AV', 'sound', 'lighting', 'LED', 'PA system'], module: 'events_entertainment_production', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'price', 'currency', 'subtitle', 'duration', 'status'] },
  { id: 'evt_client_review', family: 'social_proof', label: 'Client Reviews', stage: 'social_proof', desc: 'Event-specific criteria bars, event-type-tagged reviews', preview: MiniClientReview, intents: ['reviews', 'ratings', 'testimonials', 'feedback'], module: 'events_entertainment_social_proof', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'rating', 'review_count', 'subtitle', 'badges', 'author', 'verified', 'date'] },
  { id: 'seating_chart', family: 'planning', label: 'Seating Layout', stage: 'showcase', desc: 'Table/section assignments with guest counts per zone', preview: MiniSeatingChart, intents: ['seating', 'layout', 'tables', 'arrangement', 'floor plan'], module: 'events_entertainment_planning', status: 'active', engines: ['booking'], reads: ['name', 'description', 'image_url'] },
  ...
  { id: 'invite_rsvp', family: 'management', label: 'RSVP Tracker', stage: 'social_proof', desc: 'Guest list with sent/accepted/declined/pending counts, dietary info', preview: MiniInviteRSVP, intents: ['RSVP', 'guest list', 'invites', 'who is coming', 'headcount', 'dietary'], module: 'events_entertainment_management', status: 'active', engines: ['booking', 'engagement'], reads: ['name', 'description', 'image_url'] },
];
