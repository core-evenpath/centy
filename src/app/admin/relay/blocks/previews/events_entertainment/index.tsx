...
const EVT_BLOCKS: VerticalBlockDef[] = [
  { id: 'evt_service_card', family: 'catalog', label: 'Service Card', stage: 'discovery', desc: 'Event service with category, duration, starting price, booking count', preview: MiniServiceCard, intents: ['services', 'photography', 'videography', 'planning', 'DJ', 'decorator'], module: 'moduleItems', status: 'active' },
  { id: 'evt_portfolio', family: 'proof', label: 'Portfolio', stage: 'social_proof', desc: 'Project showcase with photo strips, event title, type tag, shot count', preview: MiniPortfolio, intents: ['portfolio', 'past work', 'samples', 'gallery', 'examples'], module: null, status: 'active' },
  { id: 'vendor_profile', family: 'people', label: 'Vendor Profile', stage: 'discovery', desc: 'Creative professional with specialties, travel radius, event count', preview: MiniVendorProfile, intents: ['who', 'photographer', 'planner', 'DJ', 'artist', 'vendor'], module: 'moduleItems', status: 'active' },
  { id: 'event_package', family: 'packages', label: 'Event Package', stage: 'showcase', desc: 'Bundled service with guest capacity, coverage hours, vendor count, savings', preview: MiniEventPackage, intents: ['packages', 'bundles', 'all inclusive', 'wedding package'], module: 'moduleItems', status: 'active' },
  { id: 'evt_availability', family: 'booking', label: 'Availability Calendar', stage: 'conversion', desc: 'Monthly calendar with open/booked dates for vendor or venue', preview: MiniAvailabilityCalendar, intents: ['available', 'dates', 'when', 'calendar', 'check date', 'book date'], module: null, status: 'active' },
  { id: 'evt_quote_builder', family: 'pricing', label: 'Custom Quote Builder', stage: 'conversion', desc: 'Event type selector, service checkboxes with pricing, running total', preview: MiniQuoteBuilder, intents: ['quote', 'pricing', 'cost', 'how much', 'estimate', 'custom', 'budget'], module: null, status: 'active' },
  { id: 'evt_timeline', family: 'planning', label: 'Planning Timeline', stage: 'social_proof', desc: 'Multi-phase milestone tracker from consultation to event day', preview: MiniEventTimeline, intents: ['timeline', 'progress', 'planning status', 'milestones', 'checklist'], module: null, status: 'active' },
  { id: 'evt_venue_card', family: 'venues', label: 'Venue Card', stage: 'discovery', desc: 'Event venue with capacity, area, pricing, amenity list, virtual tour CTA', preview: MiniVenueCard, intents: ['venue', 'space', 'hall', 'location', 'capacity', 'banquet', 'garden'], module: 'moduleItems', status: 'active' },
  { id: 'show_listing', family: 'entertainment', label: 'Show Listing', stage: 'discovery', desc: 'Upcoming shows with type tag, date/time, venue, ticket price, seat count', preview: MiniShowListing, intents: ['shows', 'events', 'tickets', 'tonight', 'upcoming', 'performance'], module: 'moduleItems', status: 'active' },
  { id: 'mood_board', family: 'design', label: 'Design Mood Board', stage: 'showcase', desc: 'Visual theme board with color palette, inspiration images, approve/revise', preview: MiniMoodBoard, intents: ['theme', 'design', 'mood board', 'colors', 'style', 'decor'], module: null, status: 'active' },
  { id: 'evt_equipment', family: 'production', label: 'AV & Equipment', stage: 'showcase', desc: 'Audio/visual/lighting catalog with daily rates, availability status', preview: MiniEquipmentList, intents: ['equipment', 'AV', 'sound', 'lighting', 'LED', 'PA system'], module: 'moduleItems', status: 'active' },
  { id: 'evt_client_review', family: 'social_proof', label: 'Client Reviews', stage: 'social_proof', desc: 'Event-specific criteria bars, event-type-tagged reviews', preview: MiniClientReview, intents: ['reviews', 'ratings', 'testimonials', 'feedback'], module: null, status: 'active' },
  { id: 'seating_chart', family: 'planning', label: 'Seating Layout', stage: 'showcase', desc: 'Table/section assignments with guest counts per zone', preview: MiniSeatingChart, intents: ['seating', 'layout', 'tables', 'arrangement', 'floor plan'], module: null, status: 'active' },
  { id: 'invite_rsvp', family: 'management', label: 'RSVP Tracker', stage: 'social_proof', desc: 'Guest list with sent/accepted/declined/pending counts, dietary info', preview: MiniInviteRSVP, intents: ['RSVP', 'guest list', 'invites', 'who is coming', 'headcount', 'dietary'], module: null, status: 'active' },
];
