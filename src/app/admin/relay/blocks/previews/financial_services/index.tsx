...
const FIN_BLOCKS: VerticalBlockDef[] = [
  { id: 'fin_product_card', family: 'catalog', label: 'Financial Product', stage: 'discovery', desc: 'Savings, loan, or card product with rate/APY, minimums, apply CTA', preview: MiniProductCard, intents: ['products', 'accounts', 'savings', 'loan', 'credit', 'rates', 'open account'], module: 'moduleItems', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'price', 'category'] },
