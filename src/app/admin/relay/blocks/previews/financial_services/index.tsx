...
const FIN_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'fin_loan_calc', family: 'tools', label: 'Loan Calculator', stage: 'showcase', desc: 'Amount, term, APR inputs with monthly payment and total cost output', preview: MiniLoanCalculator, intents: ['calculator', 'monthly payment', 'EMI', 'loan', 'mortgage', 'affordability'], module: 'financial_services_tools', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url'] },
  { id: 'fin_account_snapshot', family: 'accounts', label: 'Account Overview', stage: 'social_proof', desc: 'Multi-account summary with balances, APY, available credit', preview: MiniAccountSnapshot, intents: ['balance', 'accounts', 'overview', 'statement', 'checking', 'savings'], module: 'financial_services_accounts', status: 'active', engines: ['lead', 'service'], reads: ['name', 'description', 'image_url'] },
  { id: 'fin_application', family: 'onboarding', label: 'Quick Application', stage: 'conversion', desc: 'Streamlined apply form with product context and soft-pull trust badges', preview: MiniApplicationForm, intents: ['apply', 'open account', 'sign up', 'eligible', 'qualify'], module: 'financial_services_onboarding', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url'] },
  { id: 'fin_rate_compare', family: 'tools', label: 'Rate Comparison', stage: 'showcase', desc: 'Our rate vs market average with advantage differential per product', preview: MiniRateComparison, intents: ['rates', 'compare', 'APY', 'APR', 'best rate', 'competitive'], module: 'financial_services_tools', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url'] },
  { id: 'fin_portfolio', family: 'wealth', label: 'Portfolio Summary', stage: 'social_proof', desc: 'Total value, YTD return, asset allocation bar with per-class returns', preview: MiniPortfolioSummary, intents: ['portfolio', 'investments', 'performance', 'returns', 'allocation', 'holdings'], module: 'financial_services_wealth', status: 'active', engines: ['lead', 'service'], reads: ['name', 'description', 'image_url'] },
  ...
  { id: 'fin_credit_score', family: 'credit', label: 'Credit Health', stage: 'social_proof', desc: 'Score gauge, trend indicator, 4-factor breakdown', preview: MiniCreditScore, intents: ['credit score', 'credit health', 'my score', 'credit report', 'improve score'], module: 'financial_services_credit', status: 'active', engines: ['lead', 'service'], reads: ['name', 'description', 'image_url'] },
  { id: 'fin_transfer', family: 'payments', label: 'Money Transfer', stage: 'conversion', desc: 'Send/receive amounts with live exchange rate, fee, delivery time', preview: MiniTransferQuote, intents: ['send money', 'transfer', 'remittance', 'exchange rate', 'forex', 'wire'], module: 'financial_services_payments', status: 'active', engines: ['commerce'], reads: ['name', 'description', 'image_url'] },
  { id: 'fin_doc_upload', family: 'onboarding', label: 'Document Upload', stage: 'conversion', desc: 'KYC/verification checklist with uploaded/pending status', preview: MiniDocumentUpload, intents: ['documents', 'upload', 'KYC', 'verification', 'ID', 'proof'], module: 'financial_services_onboarding', status: 'active', engines: ['lead', 'service'], reads: ['name', 'description', 'image_url'] },
  { id: 'fin_app_tracker', family: 'tracking', label: 'Application Tracker', stage: 'social_proof', desc: '5-step pipeline from Applied to Funded with ref number and ETA', preview: MiniApplicationTracker, intents: ['status', 'track', 'application', 'approved', 'reference'], module: 'financial_services_tracking', status: 'active', engines: ['lead', 'service'], reads: ['name', 'description', 'image_url', 'status', 'last_updated', 'eta', 'location', 'progress', 'destination'] },
  { id: 'fin_advisor', family: 'people', label: 'Advisor Profile', stage: 'discovery', desc: 'CFP/CFA with credentials, AUM, client count, specialties', preview: MiniAdvisorProfile, intents: ['advisor', 'planner', 'consultant', 'CFP', 'financial advisor', 'wealth manager'], module: 'financial_services_people', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'subtitle', 'badges', 'rating', 'review_count', 'specialties', 'years_experience', 'role', 'availability'] },
  { id: 'fin_review', family: 'social_proof', label: 'Client Reviews', stage: 'social_proof', desc: 'Finance-specific criteria bars with product-tagged reviews', preview: MiniClientReview, intents: ['reviews', 'ratings', 'testimonials', 'feedback', 'trust'], module: 'financial_services_social_proof', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url', 'rating', 'review_count', 'subtitle', 'badges', 'author', 'verified', 'date'] },
  { id: 'fin_eligibility', family: 'tools', label: 'Eligibility Checker', stage: 'discovery', desc: 'Pre-qualification tool with instant result and no credit impact', preview: MiniEligibilityCheck, intents: ['eligible', 'qualify', 'pre-qualify', 'can I get', 'pre-approval'], module: 'financial_services_tools', status: 'active', engines: ['lead'], reads: ['name', 'description', 'image_url'] },
];
