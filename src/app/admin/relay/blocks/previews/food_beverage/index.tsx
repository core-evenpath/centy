...
const FB_BLOCKS: VerticalBlockDef[] = [
  { id: 'menu_item', family: 'menu', label: 'Menu Item Card', stage: 'discovery', desc: 'Food/drink item with dietary tags, spice level, calorie count, pricing', preview: MiniMenuItemCard, intents: ['menu', 'food', 'dishes', 'hungry', 'eat'], module: 'moduleItems', status: 'active', engines: ['commerce'] },
  { id: 'menu_detail', family: 'menu', label: 'Menu Item Detail', stage: 'showcase', desc: 'Full dish view with ingredients, allergens, nutrition, wine pairings', preview: MiniMenuDetail, intents: ['details', 'ingredients', 'allergens', 'about this dish'], module: 'moduleItems', status: 'active', engines: ['commerce'] },
  { id: 'category_browser', family: 'menu', label: 'Category Browser', stage: 'discovery', desc: 'Visual grid of menu sections with item counts', preview: MiniCategoryBrowser, intents: ['categories', 'sections', 'browse', 'starters', 'mains', 'desserts'], module: null, status: 'active', engines: ['commerce'] },
  { id: 'dietary_filter', family: 'preferences', label: 'Dietary Filter', stage: 'discovery', desc: 'Multi-select dietary tag filter with matched-item count', preview: MiniDietaryFilter, intents: ['vegetarian', 'vegan', 'gluten free', 'halal', 'dietary', 'allergies'], module: null, status: 'active', engines: ['commerce'] },
  { id: 'order_customizer', family: 'ordering', label: 'Order Customizer', stage: 'showcase', desc: 'Portion size selector, add-on checkboxes, special instructions, running total', preview: MiniOrderCustomizer, intents: ['customize', 'modify', 'add-ons', 'extra', 'size', 'special request'], module: null, status: 'active', engines: ['commerce'] },
  { id: 'table_reservation', family: 'booking', label: 'Table Reservation', stage: 'conversion', desc: 'Party size grid, date strip, time slots, seating preference', preview: MiniTableReservation, intents: ['reserve', 'table', 'booking', 'reservation', 'dinner', 'tonight'], module: null, status: 'active', engines: ['booking'] },
  { id: 'daily_specials', family: 'marketing', label: 'Daily Specials', stage: 'showcase', desc: 'Time-limited special dishes with original price, limited-quantity badge', preview: MiniDailySpecials, intents: ['specials', 'today', 'recommended', 'chef special', 'limited'], module: 'moduleItems', status: 'active', engines: ['commerce'] },
  { id: 'kitchen_queue', family: 'operations', label: 'Kitchen Queue', stage: 'social_proof', desc: 'Live order pipeline 5-step tracker with estimated time remaining', preview: MiniKitchenQueue, intents: ['order status', 'how long', 'ready', 'waiting', 'prep time'], module: null, status: 'active', engines: ['service'] },
  { id: 'combo_meal', family: 'marketing', label: 'Combo / Meal Deal', stage: 'showcase', desc: 'Build-your-own combo from categories with savings percentage', preview: MiniComboMeal, intents: ['combo', 'meal deal', 'set menu', 'lunch special', 'value meal'], module: 'moduleItems', status: 'active', engines: ['commerce'] },
  { id: 'drink_menu', family: 'beverage', label: 'Drink / Beverage Menu', stage: 'discovery', desc: 'Cocktails, wine, beer list with ABV, tasting notes, per-glass pricing', preview: MiniDrinkMenu, intents: ['drinks', 'cocktails', 'wine', 'beer', 'beverages', 'bar'], module: 'moduleItems', status: 'active', engines: ['commerce'] },
  { id: 'chef_profile', family: 'people', label: 'Chef / Team Profile', stage: 'social_proof', desc: 'Executive chef card with culinary credentials, cuisine specialties', preview: MiniChefProfile, intents: ['chef', 'who cooks', 'kitchen', 'about the chef'], module: null, status: 'active', engines: ['commerce'] },
  { id: 'catering', family: 'events', label: 'Catering Package', stage: 'showcase', desc: 'Event catering with per-head pricing, minimum order, inclusions', preview: MiniCateringPackage, intents: ['catering', 'event', 'corporate', 'party', 'group order'], module: 'moduleItems', status: 'active', engines: ['commerce'] },
  { id: 'nutrition', family: 'info', label: 'Nutrition Info', stage: 'showcase', desc: 'Calorie ring chart, macro breakdown bars, allergen indicators', preview: MiniNutritionInfo, intents: ['nutrition', 'calories', 'macros', 'protein', 'nutrition facts'], module: null, status: 'active', engines: ['commerce'] },
  { id: 'diner_review', family: 'social_proof', label: 'Diner Reviews', stage: 'social_proof', desc: 'F&B-specific criteria bars and meal-tagged reviews', preview: MiniDinerReview, intents: ['reviews', 'ratings', 'feedback', 'testimonials'], module: null, status: 'active', engines: ['commerce'] },
];
