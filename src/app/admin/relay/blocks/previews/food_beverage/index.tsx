...
const FB_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'kitchen_queue', family: 'operations', label: 'Kitchen Queue', stage: 'social_proof', desc: 'Live order pipeline 5-step tracker with estimated time remaining', preview: MiniKitchenQueue, intents: ['order status', 'how long', 'ready', 'waiting', 'prep time'], module: null, status: 'active' },
