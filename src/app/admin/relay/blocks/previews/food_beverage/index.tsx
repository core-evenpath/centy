...
const FB_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'category_browser', family: 'menu', label: 'Category Browser', stage: 'discovery', desc: 'Visual grid of menu sections with item counts', preview: MiniCategoryBrowser, intents: ['categories', 'sections', 'browse', 'starters', 'mains', 'desserts'], module: 'food_beverage_menu', status: 'active', engines: ['commerce'] },
  { id: 'dietary_filter', family: 'preferences', label: 'Dietary Filter', stage: 'discovery', desc: 'Multi-select dietary tag filter with matched-item count', preview: MiniDietaryFilter, intents: ['vegetarian', 'vegan', 'gluten free', 'halal', 'dietary', 'allergies'], module: 'food_beverage_preferences', status: 'active', engines: ['commerce'] },
  { id: 'order_customizer', family: 'ordering', label: 'Order Customizer', stage: 'showcase', desc: 'Portion size selector, add-on checkboxes, special instructions, running total', preview: MiniOrderCustomizer, intents: ['customize', 'modify', 'add-ons', 'extra', 'size', 'special request'], module: 'food_beverage_ordering', status: 'active', engines: ['commerce'] },
  { id: 'table_reservation', family: 'booking', label: 'Table Reservation', stage: 'conversion', desc: 'Party size grid, date strip, time slots, seating preference', preview: MiniTableReservation, intents: ['reserve', 'table', 'booking', 'reservation', 'dinner', 'tonight'], module: 'food_beverage_booking', status: 'active', engines: ['booking'] },
  ...
  { id: 'kitchen_queue', family: 'operations', label: 'Kitchen Queue', stage: 'social_proof', desc: 'Live order pipeline 5-step tracker with estimated time remaining', preview: MiniKitchenQueue, intents: ['order status', 'how long', 'ready', 'waiting', 'prep time'], module: 'food_beverage_operations', status: 'active', engines: ['service'] },
  ...
  { id: 'chef_profile', family: 'people', label: 'Chef / Team Profile', stage: 'social_proof', desc: 'Executive chef card with culinary credentials, cuisine specialties', preview: MiniChefProfile, intents: ['chef', 'who cooks', 'kitchen', 'about the chef'], module: 'food_beverage_people', status: 'active', engines: ['commerce'] },
  ...
  { id: 'nutrition', family: 'info', label: 'Nutrition Info', stage: 'showcase', desc: 'Calorie ring chart, macro breakdown bars, allergen indicators', preview: MiniNutritionInfo, intents: ['nutrition', 'calories', 'macros', 'protein', 'nutrition facts'], module: 'food_beverage_info', status: 'active', engines: ['commerce'] },
  { id: 'diner_review', family: 'social_proof', label: 'Diner Reviews', stage: 'social_proof', desc: 'F&B-specific criteria bars and meal-tagged reviews', preview: MiniDinerReview, intents: ['reviews', 'ratings', 'feedback', 'testimonials'], module: 'food_beverage_social_proof', status: 'active', engines: ['commerce'] },
];
