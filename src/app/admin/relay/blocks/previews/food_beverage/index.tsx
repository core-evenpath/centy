...
const FB_BLOCKS: VerticalBlockDef[] = [
  { id: 'menu_item', family: 'menu', label: 'Menu Item Card', stage: 'discovery', desc: 'Food/drink item with dietary tags, spice level, calorie count, pricing', preview: MiniMenuItemCard, intents: ['menu', 'food', 'dishes', 'hungry', 'eat'], module: 'moduleItems', status: 'active', engines: ['commerce'], reads: ['name', 'description', 'image_url'] },
  { id: 'menu_detail', family: 'menu', label: 'Menu Item Detail', stage: 'showcase', desc: 'Full dish view with ingredients, allergens, nutrition, wine pairings', preview: MiniMenuDetail, intents: ['details', 'ingredients', 'allergens', 'about this dish'], module: 'moduleItems', status: 'active', engines: ['commerce'], reads: ['name', 'description', 'image_url'] },
  ...
  { id: 'daily_specials', family: 'marketing', label: 'Daily Specials', stage: 'showcase', desc: 'Time-limited special dishes with original price, limited-quantity badge', preview: MiniDailySpecials, intents: ['specials', 'today', 'recommended', 'chef special', 'limited'], module: 'moduleItems', status: 'active', engines: ['commerce'], reads: ['name', 'description', 'image_url'] },
  ...
  { id: 'combo_meal', family: 'marketing', label: 'Combo / Meal Deal', stage: 'showcase', desc: 'Build-your-own combo from categories with savings percentage', preview: MiniComboMeal, intents: ['combo', 'meal deal', 'set menu', 'lunch special', 'value meal'], module: 'moduleItems', status: 'active', engines: ['commerce'], reads: ['name', 'description', 'image_url'] },
  { id: 'drink_menu', family: 'beverage', label: 'Drink / Beverage Menu', stage: 'discovery', desc: 'Cocktails, wine, beer list with ABV, tasting notes, per-glass pricing', preview: MiniDrinkMenu, intents: ['drinks', 'cocktails', 'wine', 'beer', 'beverages', 'bar'], module: 'moduleItems', status: 'active', engines: ['commerce'], reads: ['name', 'description', 'image_url'] },
  ...
  { id: 'catering', family: 'events', label: 'Catering Package', stage: 'showcase', desc: 'Event catering with per-head pricing, minimum order, inclusions', preview: MiniCateringPackage, intents: ['catering', 'event', 'corporate', 'party', 'group order'], module: 'moduleItems', status: 'active', engines: ['commerce'], reads: ['name', 'description', 'image_url'] },
