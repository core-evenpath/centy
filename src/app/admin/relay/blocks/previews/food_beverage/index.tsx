...
const FB_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'table_reservation', family: 'booking', label: 'Table Reservation', stage: 'conversion', desc: 'Party size grid, date strip, time slots, seating preference', preview: MiniTableReservation, intents: ['reserve', 'table', 'booking', 'reservation', 'dinner', 'tonight'], module: null, status: 'active' },
