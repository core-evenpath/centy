...
const ECOM_BLOCKS: VerticalBlockDef[] = [
  { id: 'skin_quiz', family: 'entry', label: 'Quiz / Survey', stage: 'discovery', desc: 'Multi-step qualification quiz with progress tracking', preview: BLOCK_PREVIEWS.skin_quiz, intents: ['quiz', 'help me find', 'recommend'], module: 'ecommerce_entry', status: 'new', engines: ['commerce'] },
  ...
  { id: 'order_confirmation', family: 'commerce', label: 'Order Confirmation', stage: 'followup', desc: 'Post-purchase confirmation with order ID and delivery info', preview: BLOCK_PREVIEWS.order_confirmation, intents: ['confirm', 'receipt', 'thank'], module: 'ecommerce_commerce', status: 'active', engines: ['service'] },
  { id: 'order_tracker', family: 'commerce', label: 'Order Tracker', stage: 'followup', desc: 'Live order status with timeline steps and tracking link', preview: BLOCK_PREVIEWS.order_tracker, intents: ['track', 'status', 'where is', 'delivery'], module: 'ecommerce_commerce', status: 'active', engines: ['service'] },
  { id: 'booking', family: 'conversion', label: 'Booking / Appointment', stage: 'conversion', desc: 'Time slot picker for consultations or appointments', preview: BLOCK_PREVIEWS.booking, intents: ['book', 'appointment', 'schedule', 'reserve'], module: 'ecommerce_conversion', status: 'new' },
  ...
  { id: 'loyalty', family: 'engagement', label: 'Loyalty / Rewards', stage: 'social_proof', desc: 'Points balance, tier progress, and redeemable rewards', preview: BLOCK_PREVIEWS.loyalty, intents: ['points', 'rewards', 'loyalty', 'tier'], module: 'ecommerce_engagement', status: 'new' },
];
