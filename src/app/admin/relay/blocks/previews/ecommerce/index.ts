...
const ECOM_BLOCKS: VerticalBlockDef[] = [
  { id: 'skin_quiz', family: 'entry', label: 'Quiz / Survey', stage: 'discovery', desc: 'Multi-step qualification quiz with progress tracking', preview: BLOCK_PREVIEWS.skin_quiz, intents: ['quiz', 'help me find', 'recommend'], module: null, status: 'new' },
  { id: 'product_card', family: 'catalog', label: 'Product Card', stage: 'discovery', desc: 'Browsable item card with price, image, rating, and add-to-cart', preview: BLOCK_PREVIEWS.product_card, intents: ['show', 'browse', 'products', 'menu', 'catalog'], module: 'moduleItems', status: 'active' },
  { id: 'product_detail', family: 'catalog', label: 'Product Detail', stage: 'showcase', desc: 'Full item view with images, variants, specs, and actions', preview: BLOCK_PREVIEWS.product_detail, intents: ['details', 'tell me more', 'specs', 'about'], module: 'moduleItems', status: 'active' },
  { id: 'compare', family: 'catalog', label: 'Compare', stage: 'comparison', desc: 'Side-by-side comparison table for 2-4 items', preview: BLOCK_PREVIEWS.compare, intents: ['compare', 'difference', 'vs', 'which one'], module: 'moduleItems', status: 'active' },
  { id: 'bundle', family: 'marketing', label: 'Bundle / Set', stage: 'showcase', desc: 'Multi-item bundle with combined pricing and savings indicator', preview: BLOCK_PREVIEWS.bundle, intents: ['bundle', 'set', 'package', 'combo'], module: 'moduleItems', status: 'new' },
  { id: 'order_confirmation', family: 'commerce', label: 'Order Confirmation', stage: 'followup', desc: 'Post-purchase confirmation with order ID and delivery info', preview: BLOCK_PREVIEWS.order_confirmation, intents: ['confirm', 'receipt', 'thank'], module: null, status: 'active' },
  { id: 'order_tracker', family: 'commerce', label: 'Order Tracker', stage: 'followup', desc: 'Live order status with timeline steps and tracking link', preview: BLOCK_PREVIEWS.order_tracker, intents: ['track', 'status', 'where is', 'delivery'], module: null, status: 'active' },
  ...
  { id: 'subscription', family: 'commerce', label: 'Subscribe & Save', stage: 'conversion', desc: 'Auto-replenish subscription with frequency options and savings', preview: BLOCK_PREVIEWS.subscription, intents: ['subscribe', 'auto', 'recurring', 'replenish'], module: 'moduleItems', status: 'new' },
