...
const ECOM_BLOCKS: VerticalBlockDef[] = [
  ...
  { id: 'product_card', family: 'catalog', label: 'Product Card', stage: 'discovery', desc: 'Browsable item card with price, image, rating, and add-to-cart', preview: BLOCK_PREVIEWS.product_card, intents: ['show', 'browse', 'products', 'menu', 'catalog'], module: 'moduleItems', status: 'active', engines: ['commerce'], reads: ['name', 'description', 'image_url', 'price', 'category'] },
  { id: 'product_detail', family: 'catalog', label: 'Product Detail', stage: 'showcase', desc: 'Full item view with images, variants, specs, and actions', preview: BLOCK_PREVIEWS.product_detail, intents: ['details', 'tell me more', 'specs', 'about'], module: 'moduleItems', status: 'active', engines: ['commerce'], reads: ['name', 'description', 'image_url', 'price', 'category'] },
  { id: 'compare', family: 'catalog', label: 'Compare', stage: 'comparison', desc: 'Side-by-side comparison table for 2-4 items', preview: BLOCK_PREVIEWS.compare, intents: ['compare', 'difference', 'vs', 'which one'], module: 'moduleItems', status: 'active', engines: ['commerce'], reads: ['name', 'description', 'image_url', 'price', 'category'] },
  { id: 'bundle', family: 'marketing', label: 'Bundle / Set', stage: 'showcase', desc: 'Multi-item bundle with combined pricing and savings indicator', preview: BLOCK_PREVIEWS.bundle, intents: ['bundle', 'set', 'package', 'combo'], module: 'moduleItems', status: 'new', engines: ['commerce'], reads: ['name', 'description', 'image_url'] },
  ...
  { id: 'subscription', family: 'commerce', label: 'Subscribe & Save', stage: 'conversion', desc: 'Auto-replenish subscription with frequency options and savings', preview: BLOCK_PREVIEWS.subscription, intents: ['subscribe', 'auto', 'recurring', 'replenish'], module: 'moduleItems', status: 'new', engines: ['commerce'], reads: ['name', 'description', 'image_url'] },
