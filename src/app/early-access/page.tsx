...
import { ArrowRight, Check, MessageSquare, Bot, FileText, Zap, Shield, Users, TrendingUp, Sparkles, Clock } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen text-white overflow-x-hidden" style={{ backgroundColor: '#040d07' }}>
      ...
      <section className="relative min-h-screen flex items-center pt-20 pb-12 overflow-hidden">
        ...
        <GlowOrb className="w-[600px] h-[600px] bg-emerald-600/10 top-1/3 left-1/4 -translate-x-1/2 -translate-y-1/2" />
        <GlowOrb className="w-[400px] h-[400px] bg-teal-600/8 bottom-1/4 right-1/4" />
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 w-full">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-center lg:text-left order-2 lg:order-1">
              ...
              <p className="text-lg text-emerald-100/60 mb-8 leading-relaxed">
                AI-powered WhatsApp responses that work 24/7. Your customers get instant answers. You close more deals.
              </p>

              <div className="space-y-3 mb-8">
                {[
                  'Respond to customers in 30 seconds, not 3 hours',
                  'AI learns from your docs — accurate every time',
                  'Close 3-5 more deals per month automatically',
                ].map((benefit, i) => (
                  <div key={i} className="flex items-center gap-3 text-emerald-100/70 justify-center lg:justify-start">
              ...
              {/* Trust badges */}
              <div className="flex items-center gap-6 justify-center lg:justify-start text-sm text-emerald-100/40">
            ...
            <div className="order-1 lg:order-2">
              <div
                className="rounded-2xl p-8 border border-emerald-500/30"
              ...
              >
                {!isSubmitted ? (
                  <>
                    <div className="text-center mb-6">
                      ...
                      <p className="text-emerald-100/50 text-sm">
                        Be first in line. Early members get exclusive pricing.
                      </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-400 hover:to-emerald-500 text-white font-semibold py-4 rounded-xl transition-all shadow-lg shadow-emerald-500/25 disabled:opacity-50 disabled:cursor-not-allowed mt-2"
                      >
                        {isLoading ? (
                          <>
                    ...
                    <p className="text-emerald-100/30 text-xs text-center mt-4">
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-emerald-100/50 mb-6">
                      We'll email you when it's your turn. Check your inbox for confirmation.
                    </p>
                    <Link
                      href="/"
        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold mt-4 text-white">
              Everything to <span className="text-emerald-100/40">close more deals</span>
            </h2>
          </div>
