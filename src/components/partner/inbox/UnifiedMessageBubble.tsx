                ...
                <div className={cn(
                    ...
                    <a
                        ...
                        className={cn(
                            ...
                            isOutbound ? "hover:bg-white/10 text-gray-300" : "hover:bg-gray-200 text-gray-500"
                        )}
                    >
    ...
    return (
        <div className={cn(
            ...
            <div className={cn(
                ...
                {onDelete && (
                    <div className={cn(
                        "absolute top-1 p-1 opacity-0 group-hover:opacity-100 transition-opacity z-10",
